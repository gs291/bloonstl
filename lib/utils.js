...
export const rankColors = (name, hover) => {
    switch(name){
        case "s":
            return hover ? siteColors.rank.s.hover : siteColors.rank.s.hover;
        case "a":
            return hover ? siteColors.rank.a.hover : siteColors.rank.a.hover;
        case "b":
            return hover ? siteColors.rank.b.hover : siteColors.rank.b.hover;
        default:
            return hover ? siteColors.rank.default.hover : siteColors.rank.default.hover;
    }
}
...
export const goldCost = (gold, difficulty) => {
    ...
    return Math.round(goldCost/5) * 5; // Round to the nearest 5
}
