    ...
    "queries": {
        ...
        "items": [
            ...
            },
            {
                ...
                "description": "Gets the the latest patch updates by tower name. Name is a string of the monkey/hero name. Start is the starting pagination index (defaults to 0). The largest depth for recursive items is 4 (Items -> Items -> Items -> Items).",
                "request": {
                    "method": "POST",
        ...
        "items": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    { "key": "modifier", "type": "String!", "text": "A multi-delimited string list of modifiers the ability changes." },
