...
SELECT TowerStats.id AS tower_stats_id, \`range\`, pierce, damage,
    boss_damage, moab_damage, fortified_moab_damage, ceramic_damage, fortified_damage, lead_damage, fortified_lead_damage,
...
SELECT TowerStats.id AS tower_stats_id, \`range\`, pierce, damage,
    boss_damage, moab_damage, fortified_moab_damage, ceramic_damage, fortified_damage, lead_damage, fortified_lead_damage, projectile_count, attack_speed, income, duration, note,
