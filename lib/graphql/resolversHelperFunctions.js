...
export const getPatchByVersion = async (ds, {version}) => {
    const data = ds.patches[version]
    if (!data) {
        throw `Patch v ${version} not found`;
    }
    return data;
}

export const getLatest3PatchUpdatesByTowerName = async  (ds, {name, start}) => {
