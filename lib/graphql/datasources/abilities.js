...
export default class AbilitiesAPI extends DataSource {
    ...
    async getAllAbilities() {
        ...
        if (!abilities.length) {
            throw new ApolloError(`Internal Server Error:\n -- getAllAbilities DataSource Error: Could not find abilities.`);
        }
        return abilities;
    }
    ...
    async getAllMonkeyAbilityTiersWithInfo() {
        ...
        if (!abilities.length) {
            throw new ApolloError(`Internal Server Error:\n -- getAllMonkeyAbilityTiersWithInfo DataSource Error: Could not find abilities tiers with information.`);
        }
        return abilities;
    }
