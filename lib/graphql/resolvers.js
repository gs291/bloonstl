...
export default {
    ...
    Mutation: {
        submitMonkeyVote: (_, { vote }, { dataSources }) => dataSources.voteAPI.submitMonkeyVote({vote}),
        submitHeroVote: (_, { vote }, { dataSources }) => dataSources.voteAPI.submitHeroVote({vote})
    }
};
