...
export const checkIfValidPath = ({top_path, middle_path, bottom_path}) => {
    ...
    if (top_path > 2) {
        if (middle_path > 0) {
            if (middle_path > 2) { return {"err": "Middle path not allowed"} }
            if (bottom_path !== 0) { return {"err": "Bottom path not allowed"} }
        } else if (bottom_path > 0) {
            if (bottom_path > 2) { return {"err": "Bottom path not allowed"} }
            if (middle_path !== 0) { return {"err": "Middle path not allowed"} }
        }
    }
    if (middle_path > 2) {
        if (top_path > 0) {
            if (top_path > 2) { return {"err": "Top path not allowed"} }
            if (bottom_path !== 0) { return {"err": "Bottom path not allowed"} }
        } else if (bottom_path > 0) {
            if (bottom_path > 2) { return {"err": "Bottom path not allowed"} }
    ...
    if (bottom_path > 2) {
        if (top_path > 0) {
            if (top_path > 2) { return {"err": "Middle path not allowed"} }
            if (middle_path !== 0) { return {"err": "Middle path not allowed"} }
