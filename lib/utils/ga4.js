...
export const TOOLTIP_PREFIX = "TP_";

export const textToGA4Text = (text) => text && text.replace(/\s/g, '_').toUpperCase();
...
export const ga4SendTooltipHover = (params) => {
    ReactGA.event("hover_content", {
