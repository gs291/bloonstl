...
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, false, 0, 3, 'Juggernaut', 'Hurls a giant spiked ball that pops lead and excels at crushing Ceramic Bloons.', 1800, 7500, '+1d,+1cd,+28p,+4.8r,1.0s,type:normal', 'lead,reb', 'atksp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 1, 2, 'Bionic Boomerang', 'Replaces arm with a strong bionic arm that can throw boomerangs extremely fast and does extra damage to MOAB-class bloons', 1600, 2500, '+2md,0.238s', 'atksp', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, true, 1, 3, 'Turbo Charge', 'Makes this Monkey attack incredibly fast for 10 seconds.', 4000, 9000, 'abil:turbo_charge:45clt;10dur;+1d;*14.2857%s;desc:Buffs tower damage and increases attack speed by', 'abil', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, true, 1, 4, 'Perma Charge', 'Perma Charge has a permanent super fast attack speed. Ability increases the lethality even more.', 35000, 32000, '+3d,0.034s,abil:turbo_charge:40clt;15dur;+8d', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 1, 'Red Hot Rangs', 'Allows boomerangs to pop Frozen and Lead Bloons and do more damage to all.', 300, 490, '+1d,cross:502:attack:orbital_glaive:+1d=type:normal,type:normal,cross:052:+4d;abil:turbocharge:+2d', 'lead,frzn', DEFAULT);
...
INSERT INTO `AbilityTiersInfo` VALUES (NULL, @ability_tiers_boomerang_monkey_a, 'blimp,frzn,lead,dps', 'fbl');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 1, 2, 'MOAB Mauler', 'MOAB Maulers do much more damage to MOAB-Class Bloons.', 1100, 2700, '+5r,+1cd,+18md', 'blimp,moab,bfb,zomg', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, true, 1, 4, 'MOAB Eliminator', 'Assassinate ability does 6x damage with a shorter cooldown.', 25000, 35000, '+69md,type:normal,abil:moab_assassin:10clt;4500d', 'zomg,ddt,bad', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 2, 'Cluster Bombs', 'Throws out secondary bombs instead of sharp fragments every shot.', 800, 2500, 'attack:frags:1d;8j;10p;15r;type:normal', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 4, 'Bomb Blitz', 'Deals much more damage and gains the passive Bomb Storm Ability - when lives are lost, the Bomb Storm automatically triggers which destroys all but the biggest of Bloons.', 35000, 25000, '+4d,abil:bomb_blitz:40clt;2000d;-1p;-1r;type:normal;+camo;desc:Passive ability that is triggered on leak;note:destroys anything remaining below BFB', 'abil,supp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, false, 0, 3, 'Ring of Fire', 'Damages many more Bloons with a deadly ring of flame instead of tacks.', 3500, 9500, '+1d,+59p,0.5355s,type:fire,-purp', DEFAULT, 'purp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, false, 1, 1, 'Super Range Tacks', 'Even longer range tacks that can pop more Bloons.', 225, 500, '+1p,+4r,cross:420:+9p,cross:025:+5p;+12r', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 4, 'Super Maelstrom', 'Even more powerful Maelstrom ability and lasts longer.', 15000, 28000, '+1d,type:normal,abil:maelstrom:9dur;2d;4j;500p;0.0333s;type:normal', 'lead,frzn', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, false, 2, 1, 'Even More Tacks', 'Shoots out 12 tacks per shot.', 100, 490, '+2j,cross:402:+1d', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, true, 1, 4, 'Absolute Zero', 'Ability is so cold it freezes all regular Bloons for longer, including White, Zebra, and Camo, slows MOAB-class longer, and greatly increases the attack speed of all Ice Monkeys for the duration.', 26000, 27500, '+200p,+10r,+blimp,attack:slow:60%slow,note:(0-5-0) blimps will take damage but cannot be frozen,abil:snowstorm:20clt;1d;-1p;-1r;+camo;type:normal;note:all ice towers gain 66.66% attack speed buff for 10 seconds;note:(0-5-0) applies frozen status 10 seconds duration', 'blimp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 2, 2, 'Cryo Cannon', 'Shoots freezing bombs at Bloons over longer range.', 1950, 2500, '+1d,-10p,1s,-7r,-blimp,note:(0-0-3) applies frozen status (1.5s duration)', DEFAULT, 'blimp');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 2, 3, 'Icicles', 'Frozen Bloons grow sharp icicles that can pop Bloons that touch them.', 2000, 9000, 'attack:icicles:2d;3p;type:sharp;desc:Icicles attached to frozen bloons', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 2, 4, 'Icicle Impale', 'Shoots huge icicle spikes that do huge damage to MOAB-Class Bloons and freezes them.', 30000, 30000, '+48md,*75%s,type:shatter,+blimp,note:(0-0-5) Frozen ZOMGSs are 50% slower,note:(0-0-5) Other frozen blimps move at ZOMGs\' original speed', 'blimp,white', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 4, 'The Bloon Solver', 'Bloons a problem? Here\'s the solution.', 22000, 37500, '2j,*25%s,status:glue:3cd;4md,attack:splat:5p;12r;note:(0-0-5) applies glued status;desc:Deals damage on basic attack contact', 'supp', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 3, 'Glue Strike', 'Glue Strike Ability: Glues all Bloons on screen, causing them to take more damage from all sources while it lasts.', 3500, 8500, 'abil:glue_strike:30clt;-1p;-1r;+camo;-blimp;desc:Glues all bloons on screen;status:weakening_glue:11dur=+2d=-blimp=50%slow=note:(0-4-0) soaks 6 layers=desc:Take extra damage and no sharp immunity', 'abil,supp,bln', '');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 4, 'Glue Storm', 'Glue storm ability pelts the whole screen over 15 seconds with glue. Glued Bloons take extra damage while glued.', 15000, 25000, 'abil:glue_strike:30clt;15dur;-1p;-1r;2.0s;+camo;status:weakening_glue:22dur=75%slow=note:(0-5-0) soaks 9 layers', DEFAULT, DEFAULT);

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 0, 'Stickier Glue', 'Makes glue effect last much longer.', 120, 130, 'status:glued:+13dur,cross:051:abil:glue_strike:status:weakening_glue:48dur', 'cc', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 1, 'Stronger Glue', 'Slows down Bloons even more.', 400, 600, 'status:glued:75%slow,cross:051:abil:glue_strike:status:weakening_glue:90%slow', DEFAULT, DEFAULT);
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 0, 'Full Metal Jacket', 'Shots pop through 4 layers of Bloon. Can pop Lead and Frozen Bloons.', 350, 120, '+2d,type:normal', 'lead,frzn', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 1, 'Large Calibre', 'Shots can pop through 7 layers of Bloon', 1500, 800, '+3d', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 2, 'Bouncing Bullet', 'Shots bounce to new targets up to 3 times.', 3200, 2500, '4i,note:(0-3-0) Basic attack now jumps to targets within 50 units,attack:shrapnel:+1p', 'jump', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 2, 3, 'Full Auto Rifle', 'Fully automatic weapon with incredible popping power, including damage to Lead Bloons.', 4250, 10000, '*50%s', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 1, 'Advanced Intel', 'Allows long range targeting of bloons that are in the radius of your other towers.', 500, 750, 'note:(2-0-0) uses shared range that can target anything in the visibile range circle of any tower,cross:230:note:(2-3-0) missiles also gain shared range', 'rang', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 3, 'First Strike Capability', 'A devastating missile strike on the largest Bloon on screen.', 13000, 20000, 'abil:first_strike:60clt;0.6del;10000d;-1r;type:normal;+camo;desc:Huge damage on largest bloon;0.6del;attack:first_strike_explosion:350d=80p=65r=type:normal=note:penetrates blimp layers', 'abil', 'time');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 2, 4, 'Sub Commander', 'Grants +4 pierce and +1 damage to all Subs in its radius.', 25000, 25000, '*50%s,buff:command:+4p;desc:Doubles damage and increased pierce to all attacks;note:affects all subs in range including self', 'tbf', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, true, 1, 4, 'Pirate Lord', 'Greatly increased attack speed for all attacks and can shoot 3 grappling hooks at once, plundering extra cash from each MOAB-class Bloon taken down.', 21000, 35000, '*50%s,attack:grape:+4d;+5cd;*50%s,abil:takedown:30clt;+2j;desc:Harpoons up to 3 MOAB class bloons and brings it down;note:(0-5-0) Hooks all blimps other than BAD. ZOMGs use 2 hooks;note:(0-5-0) Gains double cash', 'zomg,ddt,mny,atksp', 'bad');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 0, 0, 'Rapid Fire', 'Shoots faster than normal.', 650, 160, '*75%s,cross:110:attack:pineapple:*60%s,cross:130:attack:pineapple:*60%s', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 1, 2, 'Bomber Ace', 'Drops a line of bombs when crossing the Bloon track.', 900, 2500, 'attack:pineapple:4j;1.7s;+2d;+10r;attack:pineapple_explosion:+2d=+10r=1.7s=type:explosion', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 3, 'Ground Zero', 'Bomb damage increased significantly. Ability drops a huge bomb that destroys most things on screen.', 14000, 15000, 'attack:pineapple:+7d;+20p,abil:ground_zero:45clt;0.7del;0.7del;700d;1000p;type:normal;desc:Drops a huge bomb on the screen', 'abil', 'time');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 4, 'Tsar Bomba', 'A very, very large bomb. Someone put a stop to this craziness!', 35000, 30000, 'attack:pineapple:type:normal,abil:ground_zero:35clt;3000d;5000p;type:normal;status:stun:8.2dur=desc:Applied after bomb explosion', 'lead,frzn', DEFAULT);

--          Botttom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 0, 'Sharper Darts', 'Darts can pop 8 Bloons each.', 500, 160, '+3p,cross:011:attack:pineapple:attack:pineapple_explosion:+12p,cross:031:attack:pineapple:+12p', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 4, 'Flying Fortress', 'This is a BIG plane', 100000, 45000, '*68.66%s,+2j,attack:dart:+2d;type:normal,attack:bomb:+2d,type:normal', 'blnc', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 3, 'Support Chinook', 'Drops lives and cash crates, or can pick up and redeploy most Monkey types.', 12000, 15000, 'abil:redeploy:60clt;desc:Move most towers;note:move a tower except for: aces. helis. farms. villages. aircraft carriers (4xx or 5xx buccaneers). temples (4xx or 5xx supers),abil:supplies:3mpr;+1800mon;desc:Drops a cash/health crate;note:(0-4-0) Crate drops 10 lives', 'supp,abil,mny,hlth', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 4, 'Special Poperations', 'Deploys a powerful special Monkey Marine with machine gun.', 30000, 40000, 'abil:special_poperations:25clt;30dur;6d;20p;50r;0.05s;type:normal,abil:supplies:+2700mon;note:(0-5-0) +15 lives', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 4, 'Comanche Commander', 'Upgraded weapons. Also automatically calls in 3 more Comanches. Permanently.', 35000, 50000, '+1d,abil:comanche_defense:+1d;note:(0-0-5) Comanches now are permanent', DEFAULT, 'chep');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 0, 'Bigger Blast', 'Bigger shells deliver a bigger blast radius.', 500, 180, '+5p,+8r,cross:103:note:attack:flare:+20r,cross:104:attack:strip:+5p=+8r,cross:105:attack:wall_of_fire:+5p=+6r', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 1, 'Bloon Buster', 'Smash through 2 layers of bloon at once!', 650, 600, '+1d,cross:205:attack:wall_of_fire:+1d', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 2, 'Shell Shock', 'Each blast creates a shockwave that stuns Bloons at impact point and pops Bloons further out.', 1100, 2500, '+10r,attack:stun_explosion:0.5dur;45p;19r;-blimp;-black;-zebra;desc:Stuns on basic attack expire,attack:shockwave:1d;45p;57r;desc:Deals damage on basic attack expire;note:attack is only on outer inner half of radius', 'stnb', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 3, 'The Big One', 'Devastating explosions pop 5 layers of bloon.', 8000, 15000, '+3d,+40p,+20r,type:normal,attack:stun_explosion:+40p;+10r,attack:shockwave:+40p;+30r;type:normal', 'dps', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 4, 'The Biggest One', 'Smashes through 20 layers of Bloon over a huge area.', 28000, 36000, '+15d,+20cd,20md,+115p,+16r,type:normal,attack:stun_explosion:+115p;+8r,attack:shockwave:+115p;+10cd;+24r;type:normal', 'dps,black', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, true, 1, 3, 'Artillery Battery', 'Artillery battery has 3 barrels for triple the pain.', 5500, 12500, '*25%s,abil:bombardment:60clt;8dur;*25%s;+15%r;desc:Increased tower attack speed and range', 'atksp,abil', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 1, 'Burny Stuff', 'Damaged Bloons are set ablaze momentarily with each hit.', 500, 650, 'status:burn:3.85dur;1d;1.25s;type:fire;desc:Status applied on basic attack damage,cross:302:status:burn:2d;1.5s,cross:502:status:burn:25d;1.5s', DEFAULT, DEFAULT);
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 0, 'Focused Firing', 'Increases accuracy of the Dartling Gun.', 300, 150, 'note:(1-0-0) spread reduced to 9.2 degrees', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 4, 'Ray of Doom', 'Creates a solid line of annihilation. You can erase most Bloons at your leisure', 95000, 75000, '+24d,+14std,+950p,type:normal,status:shocked:+19d,note:(5-0-0) solid beam to edge of screen', 'gbl', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, true, 1, 3, 'Rocket Storm', 'Rocket Storm ability: Launches a powerful storm of rockets in a wide cone.', 4800, 14000, '+2p,attack:explosion:+2p,abil:rocket_storm:40clt;9.5dur;1i;10j;0.5s;desc:Launches a powerful storm of rockets;attack:rocket_storm_explosion:6d=10p=8r=type:normal=desc:Deals damage on rocket contact;note:can shoot past obstacles', 'abil,bln', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 1, 'Powerful Darts', 'Darts move faster and can pop 3 bloons each.', 1200, 650, '+2p,type:shatter,cross:402:+23p,note:(0-0-2) bug shatter type from this crosspath overrides any other changes to damage type', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 4, 'Bloon Exclusion Zone', 'Upgraded to 6 barrels and massively increased damage. Bloons are excluded from existence', 58000, 55000, '+6j,0.25s,+4d,+2p,note:(0-0-5) gains 2 more buckshot attacks,note:all attacks buffed', DEFAULT, 'buff,chep');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 0, 0, 'Guided Magic', 'Magic shots seek out the Bloons, even behind cover.', 125, 110, 'note:(1-0-0) moderate homing,note:(1-0-0) can see past obstacles,cross:110:attack:fireball:note:(1-1-0) can see past obstacles,cross:120:attack:wall_of_fire:note:(1-2-0) can be placed behind walls,cross:130:attack:flame:note:(1-3-0) can see past obstacles but will collide with them', 'vis', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 0, 3, 'Arcane Spike', 'Magic does extra damage to MOAB-Class Bloons and adds a 2X attack speed bonus', 10900, 11000, '+2d,+11md,*50%s,type:plasma', 'atksp,dps', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 1, 1, 'Wall of Fire', 'Creates a super hot wall of fire across the track to roast the Bloons as they pass.', 900, 700, 'attack:wall_of_fire:5.5clt;1d;15p;15r;0.15s;type:fire;4.5dur;desc:Passively places the wall on the closest track', DEFAULT, 'trkp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 2, 'Shimmer', 'Gains a dark magic attack that periodically reveals location of all nearby Camo bloons permanently.', 1700, 2200, 'attack:shimmer:200p;70r;2.5s;+camo;+decamo;desc:Attack gained by 0-0-3;note:Can see past obstacles', 'decamo', 'trkp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 4, 'Prince of Darkness', 'Reanimate even more powerful bloon servants to obliterate the enemy and buffs other Necromancers.', 24000, 30000, '+40r,*25%s,attack:shimmer:*50%s,attack:reanimate_blimp_zmoab:3s;40d;20p;type:normal;20dur;desc:Zombie MOAB/Blimp creator;note: if < 2000 pops in the graveyard use 20 to spawn zmoab,attack:reanimate_blimp_zbfb:3s;100d;50p;type:normal;13.3dur;desc:Zombie BFB Creator;note: if > 2000 pops in the graveyard use 50 to spawn zbfb', 'solo,blnc,blimp,chep', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 1, 'Plasma Blasts', 'Plasma vaporizes almost everything it touches.', 4500, 2200, '+1p,*50%s,type:plasma', 'lead', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 2, 'Sun Avatar', 'Channels power from the core of the Sun.', 22000, 7000, '+3p,+2j', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 3, 'Sun Temple', 'Tower sacrifices enhance and modify the Temple''s attacks.', 100000, 50000, '+4d,+14p,+15r,type:normal,note:(4-0-0) can see past obstacles', 'purp,abil,solo,rang,dps', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 1, 2, 'Robo Monkey', 'Half Super Monkey, half killer robot of death. Shoots from 2 guns at once!', 7000, 6000, '+3p,+1j,10dc,15~20co', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 1, 4, 'The Anti-Bloon', 'Program Directive><Eradicate Bloons><INITIATE>', 90000, 85000, '+4d,+5p,+10r,type:normal,50dc,13~17co,abil:annihilate:45clt;+2500d;+8000p;+50r;type:normal;+camo;+blimp', 'dps,purp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 2, 'Dark Knight', 'Dark blades increase knockback and pierce and deal extra damage to MOAB-class Bloons. Gains Darkshift ability to shift to a nearby location.', 5500, 6500, '2md,+4p,status:knockback:note:(0-0-3) 90% slow to leads and ceramics,abil:darkshift:20clt;desc:Tower Teleporter;note:(0-0-3) teleport to a chosen point within range', 'blimp', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 3, 'Dark Champion', 'Champion dark blades excel at puncturing and ruining all Bloon types.Gains long-range Darkshift Ability', 60000, 47500, '+1d,+1md,+2p,*50%s,type:normal,status:knockback:note:(0-0-4) 100% slow to leads and ceramics,abil:darkshift:note:(0-0-4) can teleport anywhere', 'abil,dps,atksp,dps', 'chep');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 4, 'Legend of the Night', 'We turn to him, when all hope is lost...', 240000, 100000, '+3d,+15p,+4r,abil:black_hole:120clt;8dur;desc:The map saver;note:anything about to leak is deleted instead', DEFAULT, DEFAULT);
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 0, 0, 'Ninja Discipline', 'Increases attack range and attack speed.', 300, 150, '+7r,*62%s,cross:104:attack:sticky_bomb:+11.5r=*62%s,cross:102:attack:caltrop:+7r=*62%s,cross:103:attack:flash_bomb:+7r', 'atksp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 4, 'Grand Saboteur', 'Ability duration is longer, and MOAB-Class Bloons spawn with less health during the sabotage.', 22000, 35000, 'abil:sabotage:+15dur;note:(0-5-0) 25% damage to new blimps entering the map', 'blimp', 'time');
...
INSERT INTO `AbilityTiersInfo` VALUES (NULL, @ability_tiers_ninja_monkey_a, 'abil,supp,blimp,cc,tbf', 'chep');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 0, 'Larger Potions', 'Larger potions splash in a larger area.', 250, 140, '+5p,+7r,cross:130:attack:unstable_splash:+7r,cross:104:+5p', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 2, 'Berserker Brew', 'Special brew gives Monkeys extra damage, range, and attack speed.', 1250, 2250, 'attack:brew:desc:Attack gained by 3-0-0;45r;8s;buff:berserk:desc:Damage/Pierce/Attack Speed/Range Buff=5dur=+1d=+2p=*90%s=+10%r=note:(3-0-0) lasts 5.0 seconds or 25 shots but cannot be reapplied for 5.0 seconds', 'atksp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 0, 2, 'Druid of the Storm', 'Gusts of wind blow Bloons off the track away from the exit.', 2000, 2500, 'attack:tornado:0d;30p;2.5s;type:normal;-blimp;-lead;desc:Attack gained by 3-0-0;note:sends back 100-200 units;note:removes glue and frozen status', 'kb', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 0, 3, 'Ball Lightning', 'Creates powerful balls of lightning that shoot additional lightning bolts.', 5500, 12000, 'attack:lightball:5dur;2d;43r;0.3s;desc:Attack gained by 4-0-0', 'supp', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 0, 4, 'Superstorm', 'Superstorm blasts all Bloon types for massive damage and blows them away from the exit. Can blow away ZOMGs', 80000, 35000, '+camo,attack:lightning:+2d;+camo,attack:lightball:+3d;+camo,attack:superstorm:desc:Attack gained by 5-0-0;+camo;12d;200p;4s;-bad;5.7dur;note:MOABs use 5 pierce. BFBs 20 pierce. ZOMGs 50 pierce. DDTs 10 pierce;note:Removes glue and frozen status;note:Sends back at least 100 units', 'camo', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 3, 'Jungle\'s Bounty', 'Generates 200 money plus another 100 per Banana Farm type tower near the Druid.', 5000, 11000, '+10r,attack:vine_grab:2j,abil:jungle_bounty:desc:Money generator;60clt;3mpr;+240mon;note:+$120 for every farm within range', 'abil', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 4, 'Spirit of the Forest', 'Grows thorned vines along the path that deal constant damage plus bonus damage to ceramics, and generates lives and money when ability is activated.', 35000, 40000, '+1d,+1000mon,attack:vine_grab:0.3s;status:snared:+4d,abil:jungle_bounty:note:+25 lives,attack:brambles:desc:Attack gained by 0-5-0;-1p;-1r;+camo;note:anywhere in range 2d/0.5s 10cd/0.5s 10md/0.5s sharp type;note:within 100r +1d/s (3) +4cd/s (15) +4md/s (15) sharp type;note:within 50r: +1d/s (4) +4cd/s (20) +4md/s (20) sharp type', 'mny,dps,hlth,rang', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 2, 4, 'Avatar of Wrath', 'The more bloons there are, the more damage it does', 45000, 33000, '+3d,+5r,*50%s', 'dps', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, true, 1, 4, 'Monkey-Nomics', 'For when you\'re too big to fail...', 100000, 50000, 'abil:loan:50clt;note:(0-5-0) gain $10k which does not need to be repaid', DEFAULT, 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, true, 1, 3, 'Spike Storm', 'Shoots out a thick layer of spikes over the entire track.', 5000, 11000, 'abil:spike_storm:desc:Cover the map in spikes;40clt;-1r;0.005s;1d;4md;5p;type:sharp;13dur;note:places 200 spikes randomaly on the track', 'abil', DEFAULT);
...
--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 0, 'Long Reach', 'Increases range which spikes can be deposited.', 150, 120, '+8r,+50dur,cross:041:abil:spike_storm:note:(0-4-1) +50% lifetime', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 0, 2, 'Primary Training', 'All Primary Monkeys in radius get more range, pierce and projectile speed.', 800, 2000, 'buff:primary_support:desc:Increased pierce and range buff;+1p;+10%r;note:affects primary towers', 'tbf', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, true, 1, 3, 'Call To Arms', 'Call To Arms Ability: Gives all nearby Monkeys +50% attack speed and pops for a short time.', 20000, 20000, 'abil:call_to_arms:desc:Gain increased attack speed and perice;45clt;12dur;+50%p;*66.67%s', 'abil', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, true, 1, 4, 'Homeland Defense', 'Ability affects ALL Monkeys and for 20 seconds.', 40000, 30000, 'abil:call_to_arms:45clt;20dur;+100%p;*50%s', DEFAULT, 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 3, 'Monkey City', 'Increases influence radius and gives you a free Dart Monkey every round.', 3000, 15500, '+10r,note:(0-0-4) provides a free dart monkey at the end of each round,buff:income_support:note:+15% income;desc:Increased income in range', 'tbf', DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 4, 'Monkeyopolis', 'Absorbs all nearby Banana Farms and their income, freeing up space for new Monkeys.', 5000, 28000, 'note:(0-0-5) *actual cost is $5000 times the number of non-tier-5 farms in range regardless of difficulty. These farms are sacrificed to the village when upgraded,note:(0-0-5) $300 * (amount spent on sacrifices / 2000) per round. minimum $300', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, true, 1, 4, 'Ultraboost', 'Ultra-Overclocked Monkeys gain a small but permanent boost every time they are overclocked.', 120000, 35000, '+15p,abil:overclock:30clt;note:(0-5-0) additionally applies a permanent 4% reload buff which stacks additively up to 10 times (in the case of villages this is +2.5% to range)', DEFAULT, 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, false, 2, 4, 'XXXL Trap', 'Huge Bloon Traps can trap some of the largest Bloons in them...', 60000, 40000, 'attack:trap:10000p;-bad;note:(0-0-5) build time removed;note:(0-0-5) the trap does not need to have more pierce than of a blimp in order to capture it', 'dps', 'chep,bad');
