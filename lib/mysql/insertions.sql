...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 4, 'Energizer', 'Reduces ability cooldowns everywhere by 20%. While in radius, heroes earn XP 50% faster and water Monkey ability cooldowns are halved.', 32000, 33000, 'attack:radioactive:+4d;+5cd;+950p,note:(5-0-0) while submerged abilities of water towers in range have -50% cooldown time. All other abilities have -20% cooldown time,note:(5-0-0) heroes in range gain +50% XP', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 2, '', 'New Item! See Invisibility Potion - grants short term camo detection to a Monkey Tower or Hero. Geraldo\'s attack range increases.', 0, 460, 'attack:zap:+5r,abil:see_invisibility_potion:desc:Shop Item;|200mon;note:10 rounds to restock 1. maximum of 2;buff:vision:desc:Applied by potion=+camo=note:10 round duration', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 4, '', 'New Item! Sharpening Stone - boosts the pierce of a Monkey Tower or Hero when doing sharp-type damage.', 0, 1860, 'attack:zap:1s,abil:sharpening_stone:desc:Shop Item:|200mon;note:5 rounds to restock 1. maximum of 3;buff:sharpened:desc:Applied to towers with sharp type attacks=+1p', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 16, '', 'Geraldo\'s main attack does more damage and Amaz-o-Glue now has a small effect on MOAB-class Bloons.', 0, 19260, 'attack:zap:+1d;attack:explosion:+1d,abil:tube_of_amaz_o_glue:attack:amaz_o_glue:status:glued:+0.05slow@note:(Lvl 17) 37.5% to blimps@note:(Lvl 17) MOABs use 10p, BFBs 20p, ZOMGs 50p, and DDTs 20p', DEFAULT, DEFAULT);
