...
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, true, 1, 3, 'Super Monkey Fan Club', 'Super Monkey Fan Club ability: Converts up to 10 nearby Dart Monkeys including himself into Super Monkeys for 15 seconds. Regular attack speed also increased.', 8000, 9500, '*75%s,abil:super_monkey_fan_club:50clt;15dur;desc:Transform monkeys into superfans;attack:superfans:1d=2p=40r=0.06s=type:sharp=desc:Transformed Dart Monkey;note:(0-4-0) Transforms 10 nearest dart monkeys (with upgrades up to 2-4-2) into superfans');
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, true, 1, 4, 'Plasma Monkey Fan Club', 'Elite membership of this club grants the Dart Monkeys even more power!', 50000, 30000, 'abil:super_monkey_fan_club:50clt;15dur;attack:superfans:2d=5p=40r=0.03s=type:plasma;note:(0-5-0) transforms 20 nearest dart monkeys (with upgrades up to 2-5-2) into plasmafans;note:upgrades such as 1-X-X are inherited');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 1, 'Glaives', 'Throws sharper and faster glaives instead of boomerangs.', 280, 520, '+5p,cross:204:attack:press:+120p=note:(2-0-4) +50% knockback distance,cross:205:attack:press:attack:press_explosion:-10p@+25r@*85%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 2, 'Glaive Ricochet', 'Glaives will bounce from Bloon to Bloon automatically and aggressively.', 1300, 2500, '+37p,note:(3-0-0) Basic attack jumps to a nearby target after hitting (62.5 units)');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 3, 'M.O.A.R Glaives', 'Mulitple Object Advanced Ricochet greatly enhances the already extraordinary powers of the Glaive Ricochet Monkey.', 3000, 8500, '+50p,*50%s,note:(4-0-0) Basic attack jumps to a nearby target after hitting (187.5 units)');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 4, 'Glaive Lord', 'Glaive Lord surrounds itself in 3 special glaives that shred anything that comes near. Glaive Lord\'s glaived now rip through MOAB-class Bloons, slowly tearing them apart from the inside.', 35000, 37500, 'status:shred:100md;1s;15.1dur;desc:First hit of basic attack applies shred status,attack:orbital_glaive:2d;5cd;5md;2fd;1000p;30r;0.1s;type:sharp;+camo;desc:Extra attack gained from 5-0-0');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 1, 'Red Hot Rangs', 'Allows boomerangs to pop Frozen and Lead Bloons and do more damage to all.', 300, 490, '+1d,cross:502:attack:orbital_glaive:+1d=type:normal,type:normal,cross:052:+4d;abil:turbocharge:+2d');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 2, 'Kylie Boomerang', 'Throws heavy Kylie boomerangs that follow a straight path instead of curved.', 1300, 3000, '+14p,type:normal,note:(0-0-3) Can rehit bloons after 0.3s');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 3, 'MOAB Press', 'Heavy Kylie boomerang hits MOAB-Class Bloons multiple times per throw and sometimes knocks them back a short way along the path.', 2200, 9500, 'attack:press:1d;4md;200p;49.45r;10s;type:normal;note:(0-0-4) Can rehit bloons after 0.1s;note:(0-0-4) Knocks back blimps;-bad;desc:Extra attacked gained by 0-0-4');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 4, 'MOAB Domination', 'Special knockback kylies trigger more often and do lots of extra damage.', 60000, 28000, '+10d,*50%s,attack:press:+20md;+100p;+50.55r;*50%s;+bad;attack:press_explosion:desc:Deals damage after attack press expires or 100% pierce=100d=40p=50r=type:normal=note:Also applies a burn status for (50 damage per 1 second lasting 4 seconds)');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 0, 'Bigger Bombs', 'Shoots larger bombs, they have a larger blast area and more popping power.', 350, 200, '+6p,cross:104:attack:supercluster:+6p;attack:subcluster:+36p');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 1, 'Heavy Bombs', 'Heavy duty bombs can smash through 2 layers of Bloon at once.', 650, 1000, '+1d,+10p,cross:204:attack:supercluster:+10p=+1d;attack:subcluster:+60p=+1d;attack:superbomb:+1d');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 3, 'Bloon Impact', 'Explosions become so violent Bloons are stunned for a short time when they are hit.', 3600, 10000, '+3r,status:stun:1dur;-blimp;desc:Applied to bloons on basic attack explosion');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 4, 'Bloon Crush', 'Bloon shattering explosions do massive damage and can stun MOAB-Class Bloons.', 55000, 37500, '+9d,type:normal,status:stun:2dur;+blimp;desc:Applied to bloons and blimps on basic attack explosion');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 1, 0, 'Faster Reload', 'Reloads 20% faster.', 250, 180, '*75%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 1, 1, 'Missile Launcher', 'Shoots missiles instead of bombs, missiles fly faster with longer range', 400, 640, '*73.33%s,+4r');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 3, 'Recursive Cluster', 'Every second shot the cluster bombs send out more cluster bombs for even more destruction.', 2800, 10000, 'attack:superbomb:1d;18p;12r;type:normal;desc:Every other bomb replaced by superbomb,attack:supercluster:1d;8j;10p;15r;type:normal;desc:Deals damage when superbomb expires,attack:subcluster:1d;60p;34r;type:normal;desc:Deals damage 0.45 seconds after supercluster explodes;note:visually 8 explosions are shown but it is in fact just one large one');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 4, 'Bomb Blitz', 'Deals much more damage and gains the passive Bomb Storm Ability - when lives are lost, the Bomb Storm automatically triggers which destroys all but the biggest of Bloons.', 35000, 25000, '+4d,abil:bomb_blitz:40clt;2000d;-1p;-1r;type:normal;+camo;desc:Passive ability that is triggered on leak;note:destroys anything remaining below BFB');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, false, 1, 1, 'Super Range Tacks', 'Even longer range tacks that can pop more Bloons.', 225, 500, '+1p,+4r,cross:420:+9p,cross:025:+5p;+12r');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 3, 'Blade Maelstrom', 'Blade Maelstrom ability: Covers the area in a storm of blades.', 2700, 9000, 'abil:maelstrom:20clt;3dur;1d;2j;200p;0.0333s;type:sharp;desc:Large damage spinning blade death');
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 4, 'Super Maelstrom', 'Even more powerful Maelstrom ability and lasts longer.', 15000, 28000, '+1d,type:normal,abil:maelstrom:9dur;2d;4j;500p;0.0333s;type:normal');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 0, 'Enhanced Freeze', 'Attacks faster and freezes for longer.', 225, 160, '*75%s,note:(0-1-0) frozen status duration increased to 2.2 seconds');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 1, 'Deep Freeze', 'Freezes through 2 layers of Bloon.', 350, 500, 'note:(0-2-0) frozen status soaks through 1 layer');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 2, 'Arctic Wind', 'Greatly increases pierce & gains a super cold aura that slows Bloons and freezes water nearby.', 2900, 2500, '+60p,attack:slow:40%slow;-white;-lead;-blimp;desc:Attack gained by 0-3-0');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, true, 1, 3, 'Snowstorm', 'Freezes all bloons on screen, and briefly freezes white, zebra, camo and MOAB class.', 3000, 8500, '+10r,abil:snowstorm:30clt;1d;-1p;-1r;+camo;type:shatter;desc:Freezes all bloons on screen;note:(0-4-0) applies frozen status (6 seconds duration or 3 seconds for camo/white/blimp');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 0, 'Glue Soak', 'Glue soaks through all layers of Bloon.', 200, 150, 'status:glued:note:(1-0-0) soaks all layers');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 1, 'Corrosive Glue', 'Glued Bloons pop one layer every few seconds.', 300, 550, '+blimp,note:(2-0-0) blimp glue lasts half as long,status:glued:1d;2.3s;type:normal,cross:203:note:(2-0-3) glue level 2,cross:240:abil:glue_strike:status:weakening_glue:+blimp,cross:205:status:glued:1d=2s');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 4, 'The Bloon Solver', 'Bloons a problem? Here\'s the solution.', 22000, 37500, '2j,*25%s,status:glue:3cd;4md,attack:splat:5p;12r;note:(0-0-5) applies glued status;desc:Deals damage on basic attack contact');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 1, 1, 'Glue Splatter', 'Splatters glue across up to 6 Bloons per shot.', 1800, 900, 'attack:splat:5p;13r;note:(0-2-0) applies glued status,cross:520:attack:splat:+4p=+13r,cross:025:attack:splat:+5p');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 1, 2, 'Glue Hose', 'Shoots glue 3x as fast!', 3250, 2500, '34%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 3, 'Glue Strike', 'Glue Strike Ability: Glues all Bloons on screen, causing them to take more damage from all sources while it lasts.', 3500, 8500, 'abil:glue_strike:30clt;-1p;-1r;+camo;-blimp;desc:Glues all bloons on screen;status:weakening_glue:11dur=+2d=-blimp=50%slow=note:(0-4-0) soaks 6 layers=desc:Take extra damage and no sharp immunity');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 4, 'Glue Storm', 'Glue storm ability pelts the whole screen over 15 seconds with glue. Glued Bloons take extra damage while glued.', 15000, 25000, 'abil:glue_strike:30clt;15dur;-1p;-1r;2.0s;+camo;status:weakening_glue:22dur=75%slow=note:(0-5-0) soaks 9 layers');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 0, 'Stickier Glue', 'Makes glue effect last much longer.', 120, 130, 'status:glued:+13dur,cross:051:abil:glue_strike:status:weakening_glue:48dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 1, 'Stronger Glue', 'Slows down Bloons even more.', 400, 600, 'status:glued:75%slow,cross:051:abil:glue_strike:status:weakening_glue:90%slow');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 2, 'MOAB Glue', 'Improved glue formula allows it to stick to MOAB-Class Bloons.', 3400, 2500, '+blimp,note:(0-0-3) blimps glue lasts half as long,status:glued:note:(0-0-3) 37.5%slow to blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 3, 'Relentless Glue', 'Popped Bloons that were glued, leave a blob of glue on the track.', 3000, 8000, 'note:(0-0-4) bloons drop glue on track when fully popped that keep applying the glue status up to 2 times');
...
--          Statistics      --  (  id,             tower_id,  r, p, d,      bd,     cmd,      dc,      sd,     std,      md,     fmd,      cd,      fd,      ld,     fld,       j,    s,     mon,     dur, note, fp,  hk,      dt,     clt,      co,     del)
INSERT INTO `TowerStats` VALUES (NULL, @tower_sniper_monkey, -1, 1, 2, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1.59, DEFAULT, DEFAULT, NULL,  6, 'Z', 'sharp', DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 3, 'Maim MOAB', 'Immobilizes MOAB-Class Bloons for a short time.', 5000, 10500, '+10d,status:stun:3dur;desc:Applied by basic attack;note:(4-0-0) 3 second duration for MOABs & BFBs 1.5 seconds. ZOMGs & DDTs 0.75 seconds');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 4, 'Cripple MOAB', 'Crippled MOABs are immobilized for longer and take extra damage from all other attacks.', 40000, 37500, '+50d,status:stun:7dur;note:(5-0-0) MOAB 7 seconds. BFB 6 seconds. ZOMG 3 seconds. DDT 4 seconds,status:crippled:+5d;desc:Applied by basic attack;note:same durations as stun');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 1, 'Shrapnel Shot', 'Damaged bloons spray out a cone of sharp shrapnel.', 450, 600, 'attack:shrapnel:1d;5j;2p;type:sharp;desc:Deals damage on basic attack damage,cross:120:attack:shrapnel:type:normal,cross:220:attack:shrapnel:+1d,cross:320:attack:shrapnel:+2d,cross:420:attack:shrapnel:+2d;note:(4-2-0) applies stun,cross:520:attack:shrapnel:+6d;note:(5-2-0) applies crippled');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 2, 'Bouncing Bullet', 'Shots bounce to new targets up to 3 times.', 3200, 2500, '4i,note:(0-3-0) Basic attack now jumps to targets within 50 units,attack:shrapnel:+1p');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 1, 'Advanced Intel', 'Allows long range targeting of bloons that are in the radius of your other towers.', 500, 750, 'note:(2-0-0) uses shared range that can target anything in the visibile range circle of any tower,cross:230:note:(2-3-0) missiles also gain shared range');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 2, 'Submerge and Support', 'Adds submerge targeting option permanently reveals Camo Bloons in its radius, but does not attack while submerged.', 500, 2250, 'note:(3-0-0) gains submerge targeting option,attack:sonar:-1p;1.5s;+decamo;desc:Replaces basic attack when submerged');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 4, 'Energizer', 'Reduces ability cooldowns everywhere by 20%. While in radius, heroes earn XP 50% faster and water Monkey ability cooldowns are halved.', 32000, 33000, 'attack:radioactive:+2d;+950p,note:(5-0-0) while submerged abilities of water towers in range have -50% cooldown time. All other abilities have -20% cooldown time,note:(5-0-0) heroes in range gain +50% XP');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 1, 2, 'Ballistic Missile', 'Missile seeks target over any distance and does extra MOAB and Ceramic damage.', 1400, 3000, '+8r,attack:missile:50r;1.105s;desc:Attack gained by 0-3-0;attack:missile_explosion:1d=5cd=5md=100p=18r=type:explosion=desc:Delayed missile explosion');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 3, 'First Strike Capability', 'A devastating missile strike on the largest Bloon on screen.', 13000, 20000, 'abil:first_strike:60clt;10000d;-1r;type:normal;+camo;desc:Huge damage on largest bloon;0.6del;attack:first_strike_explosion:350d=80p=65r=type:normal=note:penetrates blimp layers');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 4, 'Pre-Emptive Strike', 'Automatically triggers MOAB Assassin effect whenever MOAB-Class Bloon spawns from the Bloon entrance.', 32000, 45000, 'attack:missile:0.5s;attack:missile_explosion:+9d,abil:first_strike:45clt,abil:pre_emptive_strike:45clt;750d;type:normal;+camo;desc:Huge damage on a blimp entering the map');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 2, 4, 'Sub Commander', 'Grants +4 pierce and +1 damage to all Subs in its radius.', 25000, 25000, '*50%s,buff:command:+4p;desc:Doubles damage and increased pierce to all attacks;note:affects all subs in range including self');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 0, 3, 'Aircraft Carrier', 'Launches waves of fighter planes that strafe the Bloons.', 7500, 12500, 'attack:forward_dart:1d;2j;9p;0.15s;desc:One of three permanent plane subtowers;note:(4-0-0) can only aim in front,attack:radial_dart:1d;8j;9p;1.0s;desc:One of three permanent plane subtowers,attack:moab_missile:-1r;3s;-bloon;note:moderate homing;desc:One of three permanent plane subtowers;attack:moab_missile_explosion:15d=3p=30r=type:explosion=desc:Deals damage on moab missile explosion,note:New attacks do not inherit alchemist buffs');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 0, 4, 'Carrier Flagship', 'Does extra damage. Can place other Monkeys on the upper decks of the ship and increases attack speed of all water based Monkeys and Monkey Aces.', 25000, 37000, 'type:normal,attack:forward_dart:+1d;1j;+3cd;+5p;-1r;type:normal;note:(5-0-0) aimed according to the main tower\'s targeting instead of straight forward,attack:radial_dart:+1d;+3cd;+5p;type:normal,attack:moab_missile:*50%s;attack:moab_missile_explosion:+15d=+1p=type:normal,buff:flagship:*85%s;desc:Increased attacked speed;note:affects all water towers and aces including self,note:+2 small platforms to place towers');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 1, 0, 'Grape Shot', 'Adds a spray of 5 sharpened grapes to the ship.', 550, 200, 'attack:grape:1d;5j;1p;1.3s;desc:Attack gained by 0-1-0,cross:310:attack:grape:*40%s,cross:014:attack:grape:0.75s');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 1, 1, 'Hot Shot', 'Burning hot grape shot can pop Lead Bloons and set Bloons on fire.', 500, 650, 'attack:grape:type:fire;status:burn:3.1dur=type:fire=1d=1.5s=desc:Grape applies burn');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 1, 2, 'Cannon Ship', 'Add a powerful cannon that shoots out powerful bombs.', 900, 2700, 'attack:cannonball:1.2s;desc:Attack gained by 0-3-0;attack:cannonball_explosion:1d=28p=40r=type:explosion=desc:Deals damage on cannonball contact;attack:frags:1d=8j=1p=type:sharp=note:damage cannot be buffed=desc:Deals damage on cannonball contact');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, true, 1, 4, 'Pirate Lord', 'Greatly increased attack speed for all attacks and can shoot 3 grappling hooks at once, plundering extra cash from each MOAB-class Bloon taken down.', 21000, 35000, '*50%s,attack:grape:+4d;+5cd;*50%s,abil:takedown:30clt;+2j;desc:Harpoons up to 3 MOAB class bloons and brings it down;note:(0-5-0) Hooks all blimps other than BAD. ZOMGs use 2 hooks;note:(0-5-0) Gains double cash');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 2, 0, 'Long Range', 'Much longer range and projectiles fly faster.', 180, 150, '+1p,+11r,cross:011:attack:grape:+1p,cross:401:attack:forward_dart:+1p;attack:radial_dart:+1p');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 2, 3, 'Favored Trades', 'Attacks faster and generates lots of money per round. Monkeys in radius have increased sell value and can stack up to 3 Favored Trades for 95% max sell value.', 5500, 10000, '+300mon,*50%s,buff:cashback:desc:Increases sellback price;note:increases sellback price by 10% of anything in range including self');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 2, 4, 'Trade Empire', 'Generates more cash per round, increases cash earned by up to 20 other Merchantmen by the number of Merchantmen, and boosts all Merchantmen damage.', 23000, 4000, '+300mon,+1d,+1cd,+1md,buff:trade:desc:Buccaneer damage and money buff;+1d;+1cd;+1md;note:trade buff affects up to 2-0 X-X-3 or X-X-4 buccaneers;note:+$20 * n income where n is the number of buffed towers');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 3, 'Ground Zero', 'Bomb damage increased significantly. Ability drops a huge bomb that destroys most things on screen.', 14000, 15000, 'attack:pineapple:+7d;+20p,abil:ground_zero:45clt;0.7del;700d;1000p;type:normal;desc:Drops a huge bomb on the screen');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 4, 'Tsar Bomba', 'A very, very large bomb. Someone put a stop to this craziness!', 35000, 30000, 'attack:pineapple:type:normal,abil:ground_zero:35clt;3000d;5000p;type:normal;status:stun:8.2dur=desc:Applied after bomb explosion');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 1, 'Centered Path', 'New central flight path for maximum map coverage.', 300, 600, 'note:(0-0-2) gains centred path targeting');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 2, 'Neva-Miss Targeting', 'Darts automatically seek out and pop Bloons by themselves.', 2200, 3000, 'note:(0-0-3) Moderate homing. Increased projectile speed');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 3, 'Spectre', 'Rapidly fires darts and bombs, dominating most Bloon types easily.', 24000, 19000, '-1r,0.06s,note:(0-0-4) alternately fires a dart and bomb,attack:dart:2d;2cd;15p;desc:Alternatively fired by basic attack,attack:bomb:3d;2cd;30p;20r;type:explosion;desc:Alternatively fired by basic attack');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 0, 'Quad Darts', 'Shoots 4 darts per volley instead of 2.', 800, 200, '+2j,cross:104:abil:comanche_defense:+2j');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 1, 'Pursuit', 'A new targeting option enables Heli to seek and pursue the Bloons automatically.', 500, 650, 'note:(2-0-0) gains pursuit targeting option');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 2, 'Razor Rotors', 'Razor Rotor blades rip up Bloons on contact, including Lead and Frozen Bloons.', 1750, 2700, 'attack:rotor:2d;10p;35r;0.75s;type:normal;desc:Attack gained by 3-0-0');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 3, 'Apache Dartship', 'Adds a large missile array and powerful machine guns.', 19600, 650, '*75%s,attack:machinegun:1d;5p;42r;0.05s;type:sharp;desc:Attack gained by 4-0-0,attack:rocket:4j;173r;1s;desc:Attack gained by 4-0-0;attack:rocket_explosion:2d=40p=25r=type:explosion=desc:Deals damage on rocket contact');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 1, 0, 'Bigger Jets', 'Powerful jets make Heli move much faster.', 300, 150, 'note:(0-1-0) flies faster,cross:013:attack:shove:note:(0-1-3) pushes back more (MOABs -44%. BFBs -11%. ZOMGs and DDTs 22%)');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 1, 1, 'IFR', 'Allows Heli Pilot to detect and shoot Camo Bloons.', 600, 650, '+camo,cross:024:abil:comanche_defense:+camo');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 1, 2, 'Downdraft', 'Blows Bloons away from the Heli, back toward the entrance.', 3000, 3300, 'attack:downdraft:1p;32r;0.15s;-blimp;-lead;desc:Attack gained by 0-3-0;note:sends bloons 32-300 units back');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 3, 'Support Chinook', 'Drops lives and cash crates, or can pick up and redeploy most Monkey types.', 12000, 15000, 'abil:redeploy:60clt;desc:Move most towers;note:move a tower except for: aces. helis. farms. villages. aircraft carriers (4xx or 5xx buccaneers). temples (4xx or 5xx supers),abil:supplies:3mpr;+1800mon;desc:Drops a cash/health crate;note:(0-4-0) Crate drops 10 lives');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 4, 'Special Poperations', 'Deploys a powerful special Monkey Marine with machine gun.', 30000, 40000, 'abil:special_poperations:25clt;30dur;6d;20p;50r;0.05s;type:normal,abil:supplies:+2700mon;note:(0-5-0) +15 lives');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 0, 'Faster Darts', 'Darts are propelled much faster through the air.', 250, 140, 'note:(0-0-1) increased projectile speed');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 3, 'Comanche Defense', 'Automatically calls in 3 more Comanches when they\'re most needed.', 8500, 12500, 'attack:rocket:attack:rocket_explosion:+2d=+20p,abil:comanche_defense:1d;3j;3p;43r;0.15s;type:sharp;desc:Support choppers appear by bloon progress;attack:comanche_defense_rocket:1d=2cd=2md=100p=18r=type:explosion=desc:Deals damage on rocket contact;note:(0-0-4) summons up to 1 mini-comanche when a bloon crosses 25% of the track. 2 mini-comanches when a bloon crosses 50%. and 3 at 75%');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 4, 'Comanche Commander', 'Upgraded weapons. Also automatically calls in 3 more Comanches. Permanently.', 35000, 50000, '+1d,abil:comanche_defense:+1d;note:(0-0-5) Comanches now are permanent');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 2, 'Shell Shock', 'Each blast creates a shockwave that stuns Bloons at impact point and pops Bloons further out.', 1100, 2500, '+10r,attack:stun_explosion:0.5dur;45p;19r;-blimp;-black;-zebra;desc:Stuns on basic attack expire,attack:shockwave:1d;45p;57r;desc:Deals damage on basic attack expire;note:attack is only on outer inner half of radius');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, true, 1, 3, 'Artillery Battery', 'Artillery battery has 3 barrels for triple the pain.', 5500, 12500, '*25%s,abil:bombardment:60clt;8dur;*25%s;+15%r;desc:Increased tower attack speed and range');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, true, 1, 4, 'Pop and Awe', 'Rains explosions over the whole screen, popping and immobilizing all Bloons for a few seconds.', 30000, 32000, '+9cd,+3md,+3fd,+3ld,+8sd,abil:pop_and_awe:60clt;8dur;20d;-1p;-1r;1.0s;type:normal;desc:Rains explosions over the whole screen;status:stun:1dur=desc:Stuns all bloons');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 0, 'Increased Accuracy', 'Makes the shots more accurate.', 200, 140, 'note:(0-0-1) 8 units random target variance');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 1, 'Burny Stuff', 'Damaged Bloons are set ablaze momentarily with each hit.', 500, 650, 'status:burn:3.85dur;1d;1.25s;type:fire;desc:Status applied on basic attack damage,cross:302:status:burn:2d;1.5s,cross:502:status:burn:25d;1.5s');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 2, 'Signal Flare', 'Camo Bloons popped by flares lose their camouflage permanently.', 700, 2200, '+camo,attack:flare:80p;50r;desc:Attack gained by 0-0-3;+decamo;-ddt');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 3, 'Shattering Shells', 'Shattering shells strip all bloon properties off all but the biggest bloons.', 11000, 12000, 'attack:strip:40p;20r;desc:Attack gained by 0-0-4;+degrow;+defortify;-ddt;-zomg;-bad');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 2, 4, 'Blooncineration', 'Superhot burny stuff melts through 5 layers of bloon each shot, burns MOAB class bloons for extra damage, and strips DDT camo.', 40000, 35000, 'type:normal,status:burn:5d;100md;1s,attack:wall_of_fire:1d;20p;15r;0.1s;type:fire;desc:Attack gained by 0-0-5;+camo,attack:flare:+ddt,attack:strip:+ddt');
...
--          Statistics      --  (  id,               tower_id,  r, p, d,      bd,     cmd,      dc,      sd,     std,      md,     fmd,      cd,      fd,      ld,     fld,       j,   s,     mon,     dur, note, fp,  hk,      dt,     clt,      co,     del)
INSERT INTO `TowerStats` VALUES (NULL, @tower_dartling_gunner, -1, 1, 1, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 0.2, DEFAULT, DEFAULT, NULL,  7, 'M', 'sharp', DEFAULT, DEFAULT, DEFAULT);

--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 0, 'Focused Firing', 'Increases accuracy of the Dartling Gun.', 300, 150, 'note:(1-0-0) spread reduced to 9.2 degrees');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 1, 'Laser Shock', 'Laser tipped shots shock bloons into popping again 1 second after being struck.', 900, 600, '1std,status:shocked:1dur;1d;0.95s;desc:Deals damage on basic attack damage');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 4, 'Ray of Doom', 'Creates a solid line of annihilation. You can erase most Bloons at your leisure', 95000, 75000, '+24d,+14std,+950p,type:normal,status:shocked:+19d,note:(5-0-0) solid beam to edge of screen');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 1, 2, 'Hydra Rocket Pods', 'Shoots depleted bloontonium missiles that can damage all Bloons types and trigger multiple explosions.', 5250, 2700, '+5p,0.132s,attack:explosion:1d;6p;8r;type:normal;desc:Deals damage on basic attack contact');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, true, 1, 3, 'Rocket Storm', 'Rocket Storm ability: Launches a powerful storm of rockets in a wide cone.', 4800, 14000, '+2p,attack:explosion:+2p,abil:rocket_storm:40clt;9.5dur;1i;10j;0.5s;desc:Launches a powerful storm of rockets;attack:rocket_storm_explosion:6d=10p=8r=type:normal=desc:Deals damage on rocket contact;note:can shoot past obstacles');
...
--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 0, 'Faster Swivel', 'Barrel can swivel much faster.', 150, 110, 'note:(0-0-1) rotates twice as fast');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 1, 'Powerful Darts', 'Darts move faster and can pop 3 bloons each.', 1200, 650, '+2p,type:shatter,cross:402:+23p,note:(0-0-2) bug shatter type from this crosspath overrides any other changes to damage type');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 2, 'Buckshot', 'Shoots blasts of deadly buckshot instead of darts.', 3800, 300, '+3d,6j,+1p,130r,1.5s,type:shatter,status:knockback:0.2dur;desc:Knoackback applied to bloons;note:300% slow for regular bloons. 150% for leads and ceramics');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 3, 'Bloon Area Denial System', '4-barreled auto-cannon that can be set to attack automatically.', 12000, 15000, '0.375s,note:(0-0-4) gains 3 buckshot attacks with independent targeting,note:(0-0-4) each barrel has a different vertical position. so higher ones may see over obstacles that lower ones do not');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 4, 'Bloon Exclusion Zone', 'Upgraded to 6 barrels and massively increased damage. Bloons are excluded from existence', 58000, 55000, '+6j,0.25s,+4d,+2p,note:(0-0-5) gains 2 more buckshot attacks,note:all attacks buffed');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 0, 0, 'Guided Magic', 'Magic shots seek out the Bloons, even behind cover.', 125, 110, 'note:(1-0-0) moderate homing,note:(1-0-0) can see past obstacles,cross:110:attack:fireball:note:(1-1-0) can see past obstacles,cross:120:attack:wall_of_fire:note:(1-2-0) can be placed behind walls,cross:130:attack:flame:note:(1-3-0) can see past obstacles but will collide with them');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 0, 4, 'Archmage', 'A true master of magical wizardry. Gives the monkey Shimmer and Dragon''s Breath. Also doubles magic bolt fire rate and increases its pierce and damage', 32000, 35000, '+2d,+6md,+4p,*50%s,attack:shimmer:200p;70r;2.5s;+camo;+decamo;desc:Attack gained by 5-0-0,attack:flame:1d;1cd;4p;70r;0.1s;type:fire;desc:Attack gained by 5-0-0;status:burn:1d=1.5s=type:fire=3.1dur=desc:Burn status applied with flame attack');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 1, 0, 'Fireball', 'Every few seconds casts an explosive fireball spell.', 300, 130, 'attack:fireball:1d;2.2s;type:fire;desc:Attack gained by 0-1-0;attack:explosion:1d=15p=10r=type:explosion=desc:Deals damage on fireball damage');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 1, 1, 'Wall of Fire', 'Creates a super hot wall of fire across the track to roast the Bloons as they pass.', 900, 700, 'attack:wall_of_fire:5.5clt;1d;15p;15r;0.15s;type:fire;4.5dur;desc:Passively places the wall on the closest track');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 1, 2, 'Dragon\'s Breath', 'Spews endless flames at nearby Bloons and enhances Fireball and Wall of Fire.', 3000, 2600, 'attack:fireball:attack:explosion:+8d,attack:wall_of_fire:4.5clt;0.1s,attack:flame:1d;1cd;4p;50r;0.1s;type:fire;desc:Attack gained by 0-3-0;status:burn:1d=1.5s=3.1dur=type:fire=desc:Applies burn with flame attack');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, true, 1, 3, 'Summon Phoenix', 'Powerful phoenix wreaks Bloon havoc for 20 seconds.', 4000, 13000, 'abil:summon:45clt;20dur;desc:Summons Phoenix subtower;attack:summon_flame:5d=10p=-1r=0.1s=type:fire=+camo=desc:Attack gained by Phoenix subtower;note:(0-4-0)summons phoenix subtower that does not inherit buffs but can receive buffs by flying through their range of influence');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, true, 1, 4, 'Wizard Lord Phoenix', 'Wizard Lord becomes a master of the flame, turns into a super powerful Lava Phoenix for a short time.', 54000, 35000, 'attack:fireball:attack:explosion:+18d,attack:wall_of_fire:+2d,attack:flame:+5d;+46p,abil:summon:45clt;20dur;desc:Transforms into Phoenix Lord;attack:summon_flame:+15d=50p=-1r=0.1s=type:normal=+camo=desc:Attack gained by Phoenix Lord;attack:meteor:50d=8j=500p=-1r=1s=type:normal=+camo=desc:Attack gained by Phoenix Lord;note:(0-5-0) technically a separate tower. Not affected by buffs from original wizard');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 2, 'Shimmer', 'Gains a dark magic attack that periodically reveals location of all nearby Camo bloons permanently.', 1700, 2200, 'attack:shimmer:200p;70r;2.5s;+camo;+decamo;desc:Attack gained by 0-0-3;note:Can see past obstacles');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 3, 'Necromancer: Unpopped Army', 'Reanimate recently popped enemies as servants to destroy the Bloons.', 2800, 10000, 'attack:reanimate:40r;4j;1.5s;2d;11p;type:normal;desc:Spawning bloon attack gained by 0-0-4;10dur;note:(0-0-4) spawns 1-4 zombloons (each using 1-10 pops from the graveyard) that travel backwards along the track,note:(0-0-4) gains a graveyard that holds up to 500 bloon layers,note:(0-0-4) Pops after round 80 are worth 7-13 graveyard bloons,note:(0-0-4) +1d for every 200 graveyard bloons stacking additively up to 10 times,note:(0-0-4) -10%s for every 100 graveyard bloons stacking additively up to 5 times');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 4, 'Prince of Darkness', 'Reanimate even more powerful bloon servants to obliterate the enemy and buffs other Necromancers.', 24000, 30000, '+40r,*25%s,attack:shimmer:*50%s,attack:reanimate_blimp_zmoab:3s;40d;20p;type:normal;20dur;desc:Zombie MOAB/Blimp creator;note: if < 2000 pops in the graveyard use 20 to spawn zmoab,attack:reanimate_blimp_zbfb:3s;100d;50p;type:normal;13.3dur;desc:Zombie BFB Creator;note: if > 2000 pops in the graveyard use 50 to spawn zbfb');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 0, 'Laser Blasts', 'Shoots powerful blasts of a laser instead of darts.', 2500, 500, '+1p,type:energy,note:(1-0-0) shoots from eye level instead of hand level so can see over some obstacles');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 3, 'Sun Temple', 'Tower sacrifices enhance and modify the Temple''s attacks.', 100000, 50000, '+4d,+14p,+15r,type:normal,note:(4-0-0) can see past obstacles');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 0, 4, 'True Sun God', 'Tremble before the AWESOME power of the TRUE Sun God!!	', 500000, 150000, '+10d,note:(5-0-0) when upgraded absorbs all towers in range for even more power with all four tower categories in effect');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 1, 3, 'Tech Terror', 'Destroys most Bloons completely and utterly within blast radius.', 19000, 35000, '+2p,0.048s,type:plasma,abil:annihilate:45clt;2500d;2000p;70r;type:normal;+camo;+blimp;desc:Obliterate bloons/blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 1, 4, 'The Anti-Bloon', 'Program Directive><Eradicate Bloons><INITIATE>', 90000, 85000, '+4d,+5p,+10r,type:normal,50dc,13~17co,abil:annihilate:45clt;+2500d;+8000p;+50r;type:normal;+camo;+blimp');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 2, 0, 'Knockback', 'Bloons get pushed backward or slowed after each hit.', 3000, 550, 'status:knockback:0.5dur;desc:Bloon and Blimp knockbacker;note:(0-0-1) 125% slow (move backwards at 25% speed) for regular bloons. 60% for leads and ceramics. 30% for blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 2, 'Dark Knight', 'Dark blades increase knockback and pierce and deal extra damage to MOAB-class Bloons. Gains Darkshift ability to shift to a nearby location.', 5500, 6500, '2md,+4p,status:knockback:note:(0-0-3) 90% slow to leads and ceramics,abil:darkshift:20clt;desc:Tower Teleporter;note:(0-0-3) teleport to a chosen point within range');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 3, 'Dark Champion', 'Champion dark blades excel at puncturing and ruining all Bloon types.Gains long-range Darkshift Ability', 60000, 47500, '+1d,+1md,+2p,*50%s,type:normal,status:knockback:note:(0-0-4) 100% slow to leads and ceramics,abil:darkshift:note:(0-0-4) can teleport anywhere');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 4, 'Legend of the Night', 'We turn to him, when all hope is lost...', 240000, 100000, '+3d,+15p,+4r,abil:black_hole:120clt;8dur;desc:The map saver;note:anything about to leak is deleted instead');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 0, 0, 'Ninja Discipline', 'Increases attack range and attack speed.', 300, 150, '+7r,*62%s,cross:104:attack:sticky_bomb:+11.5r=*62%s,cross:102:attack:caltrop:+7r=*62%s,cross:103:attack:flash_bomb:+7r');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 1, 0, 'Distraction', 'Some Bloons will become distracted and move backwards.', 350, 200, 'note:(0-1-0) 15% chance to send bloons 10-300 units back');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 3, 'Bloon Sabotage', 'Lasts 15 seconds. During the sabotage, all Bloons move at half speed.', 5000, 14000, 'abil:sabotage:60clt;15dur;desc:Bloons and blimps move at half speed;note:(0-4-0) all bloons and blimps move at half speed but not children of blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 4, 'Grand Saboteur', 'Ability duration is longer, and MOAB-Class Bloons spawn with less health during the sabotage.', 22000, 35000, 'abil:sabotage:+15dur;note:(0-5-0) 25% damage to new blimps entering the map');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 2, 0, 'Seeking Shuriken', 'Shurikens will seek out and pop Bloons automatically.', 250, 140, 'note:(0-0-1) strong homing');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 2, 1, 'Caltrops', 'Throws out spiked caltrops onto the track nearby.', 400, 500, 'attack:caltrop:40r;4.4s;1d;6p;desc:Attack gained by 0-0-2;type:sharp;70dur;note:placed randomly on path');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 2, 2, 'Flash Bomb', 'Throws a flash bomb that stuns multiple Bloons.', 2750, 2500, 'attack:flash_bomb:1d;60p;40r;desc:Attack substituted for basic attacks;type:normal;status:stun:1s=desc:Stun applied to bloons;note:replaces every 4th basic attack');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 2, 3, 'Sticky Bomb', 'Throws powerful timed charges at MOAB-Class Bloons.', 4500, 15500, 'attack:sticky_bomb:60r;5s;-bloon;desc:Attack gained by 0-0-4;attack:bombed:3dur=500d;attack:bombed_explosion:100d=10p=40r=type:normal');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, false, 2, 4, 'Master Bomber', 'One Monkey MOAB demolition Machine.', 40000, 37500, 'attack:flash_bomb:+9d;status:stun:0.25dur,attack:sticky_bomb:-1r;*40%s;status:stun:1dur;attack:bombed:+500d;attack:bombed_explosion:+200d');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 1, 'Acidic Mixture Dip', 'Throws a helpful potion at nearby Monkeys that allows them to pop Lead Bloons and do extra damage to Ceramic and MOAB-class Bloons. Wears off after several attacks.', 350, 550, 'attack:acid_drip:45r;10s;desc:Attack gained by 2-0-0;buff:acidfied:desc:Limited lasting damage buff=+1cd=+1md=+1fld=+lead=note:(2-0-0) stacks by adding 10 more shots each time capped at 200');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 2, 'Berserker Brew', 'Special brew gives Monkeys extra damage, range, and attack speed.', 1250, 2250, 'attack:brew:desc:Attack gained by 3-0-0;45r;8s;buff:berserk:desc:Damage/Pierce/Attack Speed/Range Buff=5dur=+1d=+2p=*90%s=+10%r=note:(3-0-0) lasts 5.0 seconds or 25 shots but cannot be reapplied for 5.0 seconds');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 3, 'Stronger Stimulant', 'Extra strong brew has even more powerful effect on the target.', 3000, 10000, 'attack:brew:buff:berserk:12dur=+1d=+3p=*85%s=+15%r=note:(4-0-0) lasts 12.0 seconds or 40 shots');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 0, 4, 'Permanent Brew', 'Berserker brew becomes PERMANENT on Monkeys who drink it.', 60000, 30000, 'note:(5-0-0) acidified and berserk buffs are permanent (unless this alchemist is sold)');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 1, 0, 'Stronger Acid', 'Acid potions dissolve Bloons faster.', 250, 140, 'status:acid:1d;1.5s;4.55dur;desc:Acid status applied by basic attack');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 1, 2, 'Unstable Concoction', 'Coats MOAB-Class Bloons in an explosive substance that causes a large explosion when they are popped.', 3000, 2500, 'attack:unstable_potion:67.5r;6s;-bloon;50p;desc:Attack gained by 0-3-0;attack:unstable_explosion:50p=40r=type:normal=desc:Deals damage on unstable splash pop=note:(0-3-0) damage to blimps. 20 damage from MOABs. 70 damage from BFBs. 40 damage from DDTs. 400 damage from ZOMGs and BADs. 1000 damage from bosses');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, true, 1, 3, 'Transforming Tonic', 'Turns Alchemist into powerful attack Monster for 20 seconds.', 4500, 10000, 'abil:transform:desc:Transform into a monster;60clt;20dur;2d;6p;72r;0.03s;type:plasma;note:(0-4-0) transforms into a monster that can see past obstacles but will collide with them');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, true, 1, 4, 'Total Transformation', 'Transforms five Monkeys nearby into crazy attack monsters for 20 seconds.', 45000, 28000, 'abil:transform:desc:Transform into a monster along with 5 nearby towers;40clt;20dur;2d;10p;72r;0.03s;type:plasma;note:(0-5-0) additionally transforms 5 nearby towers (tier 3 or lower) into monsters');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 2, 0, 'Faster Throwing', 'Throws acid and potions faster.', 650, 700, '*80%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 2, 1, 'Acid Pool', 'If no Bloons are nearby Alchemist can drench nearby track with acid.', 450, 145, 'attack:puddle:desc:Attack gained from 0-0-2;1d;5p;7dur;note:creates a puddle if no bloons in range');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 2, 2, 'Lead To Gold', 'Converts Lead Bloons to GOLD! Special solvents do extra damage to Lead Bloons, destroying them in a one shot and generating cash.', 1000, 2000, '+9ld,status:golden_lead:desc:Extra income from leads;note:gives $50 when the lead layer is popped. unaffected by income cuts or cash modifiers');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 2, 3, 'Rubber to Gold', 'Converts all Bloons partially into gold, getting more cash per pop from affected Bloons.', 2750, 8500, 'attack:gold_poition:desc:Attack gained by 0-0-4;45r;5s;-bad;15p;note:applies golden status,status:golden:desc:Increased cash modifier;note:+2 cash modifier. Making golden bloons drop 3.0x more cash (with no extra bonuses)');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 2, 4, 'Bloon Master Alchemist', 'Secret shrink potion converts all affected Bloons into Red Bloons', 40000, 24000, 'attack:shrink_potion:desc:Attack gained by 0-0-5;-bad;-1r;10s;200p;note:transforms target into a red bloon;note:MOABs use 20 pierce. BFBs and DDTs use 50 pierce. and ZOMGs use 100 pierce');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 1, 1, 'Heart of Oak', 'Thorns convert Regrow Bloons into normal Bloons.', 250, 600, '+degrow,cross:220:attack:lightning:+degrow,cross:320:attack:tornado:+degrow,cross:420:attack:lightball:+degrow,cross:520:attack:superstorm:+degrow');
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 1, 2, 'Druid of the Jungle', 'Calls a vine from the ground to entangle and crush Bloons one at a time.', 950, 2000, 'attack:vine_grab:desc:Attack gained by 0-3-0;-1r;1.4s;status:snared:1d=30p=2r=0.3s=type:normal=4.5dur=+degrow=desc:Snare and pop bloons');
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 3, 'Jungle\'s Bounty', 'Generates 200 money plus another 100 per Banana Farm type tower near the Druid.', 5000, 11000, '+10r,attack:vine_grab:2j,abil:jungle_bounty:desc:Money generator;60clt;3mpr;+240mon;note:+$120 for every farm within range');
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 4, 'Spirit of the Forest', 'Grows thorned vines along the path that deal constant damage plus bonus damage to ceramics, and generates lives and money when ability is activated.', 35000, 40000, '+1d,+1000mon,attack:vine_grab:0.3s;status:snared:+4d,abil:jungle_bounty:note:+25 lives,attack:brambles:desc:Attack gained by 0-5-0;-1p;-1r;+camo;note:anywhere in range 2d/0.5s 10cd/0.5s 10md/0.5s sharp type;note:within 100r +1d/s (3) +4cd/s (15) +4md/s (15) sharp type;note:within 50r: +1d/s (4) +4cd/s (20) +4md/s (20) sharp type');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 2, 0, 'Druidic Reach', 'Increases range by a large amount.', 100, 120, '+10r');
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 2, 1, 'Heart of Vengeance', 'Gains attack speed up to 100 lives lost after getting this upgrade, Lives above maximum do not count.', 300, 550, 'note:(0-0-2) +x% speed capped at +100% where x is 10 + (number of lives)');
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, false, 2, 2, 'Druid of Wrath', 'Gains attack speed during the round as long as the Druid is popping Bloons.', 600, 1700, 'note:(0-0-3) +5% speed per 10 damage dealt capped at +100%. Resets if this druid is idle for 2 seconds');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 0, 4, 'Banana Central', 'You want Banana? We have Banana!', 100000, 50000, '+4500mon,buff:productivity:desc:Farm Income Buff;note:+25% income to all 4-X-X farms;note:Stacks multiplicatively with X-2-X valuable bananas');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 1, 1, 'Valuable Bananas', 'Bananas are worth 25% more cash per bunch.', 800, 1000, 'note:(0-2-0) +25% income');
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 1, 2, 'Monkey Bank', 'Generates money each round and stores it in the bank. Earns 15% interest each round.', 3500, 3500, '+150mon,note:(0-3-0) bank\'s balance increases by 15% at the end of a round. up to a capacity of $7000');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, true, 1, 4, 'Monkey-Nomics', 'For when you''re too big to fail...', 100000, 50000, 'abil:loan:50clt;note:(0-5-0) gain $10k which does not need to be repaid');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 2, 0, 'EZ Collect', 'The collect radius of Bananas is larger. For Monkey Banks, glows when bank is full and ready to collect.', 250, 200, 'note:(0-0-1) banana collection radius +50% and expired bananas are worth 50%,cross:031:note:(0-3-1) has a flashing dollar sign when full');
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 2, 1, 'Banana Salvage', 'Uncollected Bananas auto-collect for half the amount.', 200, 950, 'note:(0-0-2)expired bananas now worth 85%. +10% sell back,cross:032:note:(0-3-2) auto collects if the balance was capped for the whole round');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_banana_farm, false, 2, 4, 'Monkey Wall Street', 'Hub of Monkey trades earns colossal income each round.', 60000, 50000, '4000mon,note:(0-0-5) 5 end of round lives');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, true, 1, 3, 'Spike Storm', 'Shoots out a thick layer of spikes over the entire track.', 5000, 11000, 'abil:spike_storm:desc:Cover the map in spikes;40clt;-1r;0.005s;1d;4md;5p;type:sharp;13dur;note:places 200 spikes randomaly on the track');
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, true, 1, 4, 'Carpet of Spikes', 'Regularly sets a carpet of spikes over the whole track.', 40000, 35000, '+2d,abil:spike_storm:+2d;note:(0-5-0) additionally triggered automatically every 15 seconds');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 0, 'Long Reach', 'Increases range which spikes can be deposited.', 150, 120, '+8r,+50dur,cross:041:abil:spike_storm:note:(0-4-1) +50% lifetime');
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 1, 'Smart Spikes', 'Spike Factory gains special targeting priority and accelerated production at the start of each round.', 400, 550, 'note:(0-0-2) gains 4 extra targeting options,note:(0-0-2) close targets closest point to the tower in range,note:(0-0-2)  far targets furthest point from the tower in range,note:(0-0-2)smart targets point closest to the exit on active paths only,note:(0-0-2) passive ability (1 round cooldown) 4x faster for 2.5s,cross:042:abil:spike_storm:note:(0-4-2) only target active paths');
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 2, 'Long Life Spikes', 'Spikes lasts much longer and can carry over one round.', 1400, 2100, '+40dur,note:(0-0-3) 1 round lifespan');
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 3, 'Deadly Spikes', 'Extra deadly spikes can pop through 2 layers per spike.', 3500, 9000, '+1d,note:(0-0-4) 2 round lifespan');
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, false, 2, 4, 'Perma-Spike', 'Spikes become almost permanent.', 30000, 29500, '+8d,+45p,4.85s,+160dur,note:(0-0-5) 3 round lifespan');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 0, 2, 'Primary Training', 'All Primary Monkeys in radius get more range, pierce and projectile speed.', 800, 2000, 'buff:primary_support:desc:Increased pierce and range buff;+1p;+10%r;note:affects primary towers');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 1, 0, 'Grow Blocker', 'Prevents Regrow Bloons from working while in the radius of the Village.', 250, 150, '+degrow');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, true, 1, 3, 'Call To Arms', 'Call To Arms Ability: Gives all nearby Monkeys +50% attack speed and pops for a short time.', 20000, 20000, 'abil:call_to_arms:desc:Gain increased attack speed and perice;45clt;12dur;+50%p;*66.67%s');
...
--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 0, 'Monkey Business', 'Provides 10% discount to all Monkeys and upgrades tier 3 or less purchased in the radius of the Village.', 500, 250, 'note:(0-0-1) +10% discount to base towers and upgrades to tier 3');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 1, 'Monkey Commerce', 'An additional 5% discount that can stack with up to 2 other Villages with this upgrade.', 500, 750, 'note:(0-0-2) +5% discount to base towers and upgrades to tier 3. stackable up to 3 time total');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 2, 'Monkey Town', 'All Monkeys within the radius of the Monkey Town get extra cash per Bloon pop.', 10000, 3000, 'note:(0-0-3) +50% cash modifier');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 3, 'Monkey City', 'Increases influence radius and gives you a free Dart Monkey every round.', 3000, 15500, '+10r,note:(0-0-4) provides a free dart monkey at the end of each round,buff:income_support:note:+15% income;desc:Increased income in range');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 4, 'Monkeyopolis', 'Absorbs all nearby Banana Farms and their income, freeing up space for new Monkeys.', 5000, 28000, 'note:(0-0-5) *actual cost is $5000 times the number of non-tier-5 farms in range regardless of difficulty. These farms are sacrificed to the village when upgraded,note:(0-0-5) $300 * (amount spent on sacrifices / 2000) per round. minimum $300');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, false, 1, 2, 'Cleansing Foam', 'Sprays foam that removes Regrow and Camo and pops Lead Bloons.', 800, 2000, 'attack:place_foam:desc:Foam placed at a point;60r;2s;1ld;10p;type:normal;8.5dur;+decamo;+degrow');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, true, 1, 4, 'Ultraboost', 'Ultra-Overclocked Monkeys gain a small but permanent boost every time they are overclocked.', 120000, 35000, '+15p,abil:overclock:30clt;note:(0-5-0) additionally applies a permanent 4% reload buff which stacks additively up to 10 times (in the case of villages this is +2.5% to range)');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_quincy, true, 0, 2, 'Rapid Shot', 'Triple attack speed for a short time.', 0, 0, 'abil:rapid_shot:desc:Gain increased attack speed;60clt;3.5dur;*33.33%s;note:duration increases 0.5 seconds per level');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_quincy, false, 0, 6, '', 'Quincy shoots an exploding arrow every 3rd shot.', 0, 0, 'attack:bomb_arrow:desc:Replaces every third basic attack;1d;10p;25.7r;type:explosion');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_quincy, true, 0, 9, 'Storm of Arrows', 'Covers a large area in a deadly rain of arrows.', 0, 0, 'abil:storm_of_arrows:desc:Shower the screen with arrows;70clt;3dur;6d;6md;-1p;100r;0.05s;type:sharp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, true, 0, 2, 'Cocktail of Fire', 'Hurls a flask of flammable liquid, burning bloons that pass through the fire.', 0, 0, 'abil:cocktail_of_fire:desc:Places wall of fire on the track;attack:wall_of_fire:desc:Burning wall of fire;1d=40p=15r=0.2s=12dur=type:fire=+camo=note:can see past obstacles');
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 3, '', 'Heat it up - Every few seconds creates a powerful blast wave of fire that pops Bloons and adds fire to nearby Monkeys\' attacks.', 0, 0, 'attack:heat_it_up:desc:Powerful blast wave of fire;3d;-1p;38r;type:fire;buff:heat_it_up:8dur=+1p=+1ld=+lead=desc:Gain increased pierce');
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 4, '', 'Increased popping power.', 0, 0, '+2p');
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 5, '', 'Attacks can cause a burn effect on target bloon.', 0, 0, 'status:burn:1d;1.5s;type:fire;3.05dur;desc:Applied by basic attack');
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 6, '', 'Heat it up has increased radius.', 0, 0, 'attack:heat_it_up:+5r;abil:cocktail_of_fire:attack:wall_of_fire:0.1s');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 13, '', 'Cocktail of Fire does extra damage and sets MOAB class Bloons alight.', 0, 0, 'abil:cocktail_of_fire:attack:wall_of_fire:+1d=note:(Lvl 14) burn applies to blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 19, '', 'Firestorm does hugely increased damage.', 0, 0, 'abil:firestorm:+3d;status:burn:+1d;+7.5md');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, true, 0, 2, 'Concussive Shell', 'Shoots a guided shell to the largest Bloon on screen, stunning it.', 0, 0, 'abil:concussive_shell:desc:Shoots a guided shell to the larges Bloon;16clt;-1r;2d;48p;type:normal;status:stun:1dur;note:can see past obstacles');
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 3, '', 'All Bomb Shooters and Mortar Monkeys on screen shoot 10% faster.', 0, 0, 'buff:explosive_expert:*90%s;desc:Gain increased attack speed;note:affects all bomb and mortar towers');
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 4, '', 'Makes Black Bloons less resistant to explosive attacks.', 0, 0, 'status:blast_weakness:desc:Weakens bloons to explosions;note:(Lvl 5) black property has a 50% chance of being ignored by explosions');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 6, '', 'Pops 2 layers per shot and Mortar Monkeys blast radius increased by 10%.', 0, 0, '+1d,buff:mortar_expert:desc:Gain increased radius;note:+10% blast radius;note:affects all mortars');
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 7, '', 'All Bomb Shooters near Jones get +5% range and +25% piercing power.', 0, 0, 'buff:bomb_expert:desc:Gain increased pierce and range;+25%p;+5%r;note:affects bomb towers in range');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, true, 0, 9, 'Artillery Command', 'Resets cooldown on all Bomb Shooters and Mortar Monkeys.', 0, 0, 'abil:artillery_command:80clt;desc:Cooldown reset;note:Every bomb and mortar ability is immediately ready to use');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 13, '', 'Concussive Shell affects a larger area for a longer duration.', 0, 0, 'abil:concussive_shell:+50%r;status:stun:+50%dur=note:(Lvl 14) 7.5 seconds on bloons. 4.5 seconds on blimps)');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 18, '', 'Increased attack speed and makes all Black Bloons vulnerable to explosive damage.', 0, 0, '0.2s,status:blast_weakness:note:(Lvl 19) black property is always ignored by explosions');
INSERT INTO `Abilities` VALUES (NULL, @tower_striker_jones, false, 0, 19, '', 'Artillery Command also gives double damage and popping power to all Bomb Shooters and Mortar Monkeys for 10 seconds.', 0, 0, 'abil:artillery_command:note:(Lvl 20) for the next 10s every bomb and mortar has double damage and double pierce');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 1, '', 'Nature\'s Wrath: All Druids in range get +1 pierce.', 0, 0, 'buff:natures_wrath:desc:Gain increased pierce;+1p;note:affects all druids in range');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, true, 0, 2, 'Brambles', 'Creates a spiked bush on the track that can pop 50 bloons.', 0, 0, 'abil:brambles:desc:Spiked bush placed on track;35clt;1d;50p;type:sharp;120dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 3, '', 'Every 18 seconds creates a totem that slows all bloons near the totem by 30%. Less effective vs MOAB-class Bloons.', 0, 0, 'attack:natures_ward:desc:Passively creates a slowing totem;18s;32r;15dur;30%slow;note:(Lvl 4) 30% slow for bloons. 15% for blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 4, '', 'Increased attack speed.', 0, 0, '1.1s,buff:jungle_support:desc:Gain increased range to druids;+20%r;note:affects all X-3-X+ druids');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 7, '', 'Nature\'s ward totems slow down bloons by 40%.', 0, 0, 'attack:natures_ward:note:(Lvl 8) 40% slow for bloons. 20% for blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 8, '', 'Attack pops extra layers.', 0, 0, '+2d,buff:storm_support:desc:Gain increased moab damage;+1md;note:affects all 3-X-X+ druids');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, true, 0, 9, 'Wall of Trees', 'Summons a wall of trees across the track that destroy all Bloons that enter. When full, the tress burst into money.', 0, 0, 'abil:wall_of_trees:desc:Summons a wall of trees across the track;90clt;3000p;note:pops anything up to its pierce limit with a +1 cash modifier but stores this cash until the pierce is entirely used up');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 10, '', 'Nature\'s Clarity — all Magic Monkeys in range get an additional +5 range and +2 pierce, and Druids get an additional +1 pierce.', 0, 0, 'buff:natures_wrath:+2p;note:(Lvl 11) affects magic towers in range;note:(Lvl 11) stacks with the existing +1p for druids,buff:natures_clarity:desc:Gains increased range;+5r;note:Affects magic towers in range;note:applies after all other buffs so is not affected by multipliers');
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 11, '', 'Increased attack speed.', 0, 0, '0.8s,buff:natures_energy:desc:Gain lower cooldown times;note:-5% ability cooldown times;note:Affects all magic towers');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 14, '', 'Nature''s Ward slows Bloons by 60%, and has reduced cooldown.', 0, 0, 'attack:natures_ward:12s;note:(Lvl 15) 60% slow for bloons. 30% for blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_obyn_greenfoot, false, 0, 17, '', 'Improved Wrath — all Druid of Wrath pops start each round at 200.', 0, 0, 'buff:wrath_support:desc:Druid popper;note:whenever a round starts wrath counter is set to the maximum 200 pops for +100% speed;note:affects all X-X-3+ druids');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, true, 0, 2, 'Armor Piercing Shells', 'Shots can pop Black Bloons and do extra damage to Ceramic Bloons. Duration increases as Churchill levels.', 0, 0, 'abil:armor_piercing_shells:desc:Buffs all attacks;90clt;9dur;+3cd;+3md;type:normal;note:All tower attacks have normal as its type');
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, false, 0, 3, '', 'Increased attack range.', 0, 0, '+3r');
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, false, 0, 4, '', 'Adds a fast firing machine gun to the tank.', 0, 0, 'attack:machine_gun:desc:Attack gained by Lvl 5;1d;1p;66r;0.1s;type:sharp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, true, 0, 9, 'MOAB Barrage', 'Launches a barrage of shells at up to 10 MOAB-Class Bloons on screen, dealing massive damage each time.', 0, 0, 'abil:moab_barrage:desc:Barrage of shells launched to Blimps;60clt;8dur;200d;0.5s;type:normal;note:Attacks up to 16 times or until target pops;note:gains up to 10 barrage attacks. one for each of the 10 strongest blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, false, 0, 16, '', 'Armor Piercing Shells do even more damage.', 0, 0, 'abil:armor_piercing_shells:+2d;+11cd;+11md');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_captain_churchill, false, 0, 19, '', 'MOAB Barrage and Main Gun do massively increased damage per hit.', 0, 0, 'abil:moab_barrage:30clt;+300d;note:(Lvl 20) Churchill +3 damage;note:(Lvl 20) Up to 8000 damage total per blimp)');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, true, 0, 2, 'Biohack', '4 closest Monkeys pop an extra layer per attack for 6 seconds. Affected Monkeys can\'t attack for 2 seconds after effect ends.', 0, 0, 'abil:biohack:desc:Buffs nearest towers;30clt;6dur;+1d;note:Cannot attack for 2 seconds after buff expires;note:(Lvl 3) Applies buff to 4 nearest attacking towers');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 3, '', 'Skimming - Earns +$1 for every new Bloon spawned.', 0, 0, 'attack:skimming:+1mon;note:(Lvl 4) $1 income for each new bloon spawned');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 4, '', 'Bank Hack - All banks earn +5% income.', 0, 0, 'note:(Lvl 5) affects all X-3-X+ farms');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 6, '', 'Bloon Trojan - Every few seconds sends a Trojan software virus to random Bloon. Affected Bloon spawns no children when destroyed and produces 2x cash.', 0, 0, 'attack:bloon_trojan:desc:Attack gained by Lvl 7;-1r;5s;note:targets a random bloon from pink to moab;status:corrupted:desc:Spawns no children=note:Cash bonus applied on bloon');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, true, 0, 9, 'Syphon Funding', 'Downgrades most newly spawned Bloons by 1 tier. Cash per pop from affected Bloons is double. Lasts 10 seconds.', 0, 0, 'abil:syphon_funding:desc:Spawn smaller bloons;65clt;10dur;-ddt;-bad;note:(Lvl 10) Any new spawns other than a DDT or BAD will be one rank lower and give double cash');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 10, '', 'Income increased to $300 per round.', 0, 0, '+50mon');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 11, '', 'Skimming increased to $2 per Bloon.', 0, 0, 'attack:skimming:note:(Lvl 12) Now a $2 income');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 12, '', 'Biohack increases bonus damage and affects 6 monkeys for 8 seconds.', 0, 0, 'abil:biohack:+2d;8s;note:(Lvl 13) Applies buff to 6 nearest attacking towers');
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 13, '', 'Cyber Security adds 10 lives per round and can go up to 100 over starting lives.', 0, 0, 'note:(Lvl 14) increased starting lives not available in impoppable or chimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 17, '', 'Bloon Trojan can affect BFBs and DDTs Bloons.', 0, 0, '+camo,attack:bloon_trojan:+bfb;+ddt');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 19, '', 'Syphon Funding lasts 20 seconds and cash per pop is tripled for affected Bloons.', 0, 0, 'abil:syphon_funding:20dur;note:(Lvl 20) affected bloons now give triple cash');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, true, 0, 2, 'Heartstopper', 'Prevents any Regrow from happening for 6 seconds.', 0, 0, 'abil:heartstopper:desc:Prevents any Regrow;60clt;6dur;-1r;-1p;0.1s;+degrow');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 3, '', 'Ezili\'s main attack now curses multiple bloons.', 0, 0, 'attack:splash:note:(Lvl4) Applies cursed status');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 4, '', 'Increases attack speed.', 0, 0, '1s');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 5, '', 'Damage over time lasts longer and damages faster.', 0, 0, 'status:cursed:1.8s;5.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, true, 0, 6, 'Sacrificial Totem', 'A totem that gives Camo detection, extra pierce, attack range, attack speed, and projectile speed to nearby Monkeys. Drains 10 lives.', 0, 0, 'abil:sacrificial_totem:90clt;desc:Places a totem that buffs towers;78r;30dur;note:(Lvl 7) costs 10 lives;buff:support:desc:Buffs towers=+1p=+20%r=86%s=+camo=note:affects all towers in range');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 7, '', 'Ezili\'s attack does far more damage to MOAB-Class Bloons.', 0, 0, '+19md;status:cursed:+1d;+19md');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 8, '', 'Ezili\'s attack strips off Camo, Regrow and Fortified properties from non-MOAB Class Bloons.', 0, 0, '+degrow,+defortify,+decamo,attack:splash:+degrow;+defortify;+decamo,note:(Lvl 9) Degrow defortify and decamo not applied to blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, true, 0, 9, 'MOAB Hex', 'places a curse on a MOAB-Class Bloon, it takes damage every second until annihilated.', 0, 0, 'abil:moab_hex:desc:Place a curse on a Blimp until its destroyed;60clt;25dur;-bad;note:transfers to the next target if it pops with time remaining;note:Spawns no children');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 10, '', 'Increased attack range. Increases pierce of reanimated Bloons by 50%.', 0, 0, '+2r;note:(Lvl 11)gains buff for all X-X-4+ wizards: zombloon +1 pierce zmoab +10 pierce');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 11, '', 'Heartstopper reduced cooldown and increased duration.', 0, 0, '+10md,attack:splash:+10md,abil:heartstopper:45clt;15dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 12, '', 'Base attack larger splash radius and increased pierce.', 0, 0, 'attack:splash:+10p;+3r');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 13, '', 'Faster damage over time.', 0, 0, 'status:cursed:4.05dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 14, '', 'Increased range.', 0, 0, '+2r,status:cursed:6.05dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 15, '', 'Sacrificial Totem lasts longer and only costs 1 life to use.', 0, 0, 'abil:sacrificial_totem:60dur;note:(Lvl 16) costs 1 life');
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 16, '', 'Base attack has an even larger splash radius and increased pierce.', 0, 0, 'attack:splash:+10p,+2r');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 19, '', 'MOAB Hex works faster and can destroy BAD Bloons.', 0, 0, '+20md,attack:splash:+20md,abil:moab_hex:40clt;+bad');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, true, 0, 2, 'Rallying Roar', 'All nearby Monkeys can pop +1 layer for a short time.', 0, 0, 'abil:rallying_roar:desc:Gain increased damage buff;45clt;8dur;30r;+1d;note:includes self');
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 3, '', 'Increased attack speed.', 0, 0, '0.9s');
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 4, '', 'Pat sometimes does a slap attack that pushes Bloons back a considerable distance.', 0, 0, 'attack:slap:desc:Replaces every 5th basic attack;10p;-bfb;-zomg;-ddt;-bad;status:knockback:desc:Knockback bloons=1dur=note:move backwards at 3x normal speed. Also applies aoe on contact');
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 5, '', 'Bloons hit by Pat are stunned for a short time.', 0, 0, 'attack:aoe:status:stun:desc:Stun bloons in aoe;0.3dur;+7r');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 12, '', 'Attacks stun Bloons for longer and can stun MOAB-Class Bloons briefly.', 0, 0, 'attack:aoe:status:stun:note:(Lvl 13) 0.5 seconds for bloons. 0.2 seconds for blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 19, '', 'Big Squeeze can grab several big Bloons at once.', 0, 0, 'abil:big_squeeze:note:(Lvl 20) affects up to 4 blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_adora, true, 0, 2, 'The Long Arm of Light', 'Greatly increases attack range and power for a short time & damages all Bloon Types.', 0, 0, 'abil:long_arm_of_light:desc:Gain increased pierce range and damage;45clt;10dur;note:main attack pierce and range are doubled and damage type is normal');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_adora, true, 0, 6, 'Blood Sacrifice', 'Sacrifice a targeted Tower to grant Adora large amounts of XP and boost her attack range and rate of fire for a short time.', 0, 0, 'abil:blood_sacrifice:desc:Sacrifice a tower for increased stats;10clt;10dur;buff:sacrifice:desc:Gain increased range and attack speed;note:+(10+x)%r (90-x)%s where x = amount sacrificed / 100 (capped at 15)=note:affects self and 3-X-X+ Super Monkeys in range;note:sacrifices a chosen tower to gain 4x the amount spent on it as XP');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_adora, true, 0, 9, 'Ball of Light', 'Brings forth a powerful ball of energy to strike down the Bloons.', 0, 0, 'abil:ball_of_light:desc:Ball of energy dealing tons of damage;60clt;12dur;3d;8p;-1r;0.05s;type:plasma;note:can see past obstacles');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_adora, false, 0, 19, '', 'Ball of Light is greatly improved.', 0, 0, 'abil:blood_sacrifice:60dur;note:(Lvl 20)+(10+x)%r (90-x)%s where x = amount sacrificed / 50 (capped at 40),abil:ball_of_light:20dur;20d;type:normal,note:(Lvl 20) if a super monkey is upgraded to 5-X-X with Adora in range she transforms into sun-form (+8 damage, +30 pierce)');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_admiral_brickell, true, 0, 2, 'Naval Tactics', 'Greatly increases attack speed of nearby water-based Monkeys for a short time.', 0, 0, 'abil:naval_tactics:desc:Gain increased attack speed;50clt;9dur;*50%s;note:buffs water towers in range including self');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_admiral_brickell, true, 0, 9, 'Mega Mine', 'Deploys to any water area a devastating Mine that triggers on MOABs and stuns nearby Bloons. Mega Mines last 3 rounds.', 0, 0, 'abil:mega_mine:desc:Places anti-blimp mine in selected location;60clt;4000d;100p;100r;type:normal;180dur;status:stun:5dur=desc:Stuns on mega mine contact;note:Homes in on blimps when near enough');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_admiral_brickell, false, 0, 18, '', 'Naval Tactics affects all water-based towers everywhere.', 0, 0, 'abil:naval_tactics:note:(Lvl 19) globally affects all water towers');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, true, 0, 2, 'Drone Swarm', 'Etienne launches 4 more temporary drones to wreak some Bloon popping havoc.', 0, 0, 'abil:drone_swarm:desc:Spawn extra drones;70clt;18.5dur;note:spawns 4 extra drones (1 blue 1 green 2 yellow)');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 3, '', 'Drones increase in popping power.', 0, 0, '+1p,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 4, '', 'Drone increased attack speed and infra red camera allows shooting of Camo Bloons.', 0, 0, '+camo,0.55s,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 5, '', 'Drone Swarm ability cooldown reduced.', 0, 0, 'abil:drone_swarm:55clt;+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 6, '', 'Etienne now controls 2 drones at once.', 0, 0, '+1j,note:(Lvl 7) gains targeting option "divide and conquer" that is a mix of yellow and blue drones,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 7, '', 'UAV: all Monkeys gain Camo Bloon detection.', 0, 0, 'note:(Lvl 8) Grants permanent UAV subtower,note:(Lvl 8) camo detection applied to all towers,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 8, '', 'Drones pop an extra Bloon layer.', 0, 0, '+1d,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, true, 0, 9, 'UCAV', 'high altitude surveillance drone becomes devastating combat drone for a short time.', 0, 0, 'abil:ucav:desc:UAV becomes devastating combat drone;90clt;18dur;10j;-1r;0.6s;2d;25p;type:explosion,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 10, '', 'Etienne gains a third drone to control.', 0, 0, '+1j,note:(Lvl 11) gains targeting option "zone defense" that is all different blue yellow and green drones,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 11, '', 'Drone upgrades! Increased popping power and flight speed.', 0, 0, '+3p,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 12, '', 'UCAV ability cooldown reduced.', 0, 0, 'abil:ucav:75clt,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 13, '', 'Drone damage increased greatly.', 0, 0, '+1d,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 14, '', 'UCAV damage output and duration greatly increased.', 0, 0, 'abil:ucav:20dur;+2d;+5p,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 15, '', 'Etienne\'s range, drone popping power, and Drone Swarm ability cooldown all improved.', 0, 0, '+3p,+20r,abil:drone_swarm:50clt;+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 16, '', 'UCAV damage output greatly increased again!', 0, 0, 'abil:ucav:+3d,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 17, '', 'Drone damage increased.', 0, 0, '+1d');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 18, '', 'Etienne now controls four drones all the time!', 0, 0, '+1j,abil:drone_swarm:+0.5dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_etienne, false, 0, 19, '', 'Perma-UCAV: Surveillance drone becomes permanent UCAV. When activated becomes more powerful for a short time and can pop all Bloon types.', 0, 0, 'abil:ucav:+8d;+5p;type:normal,abil:drone_swarm:+0.5dur');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, true, 0, 2, 'Leaping Sword Attack', 'Sauda\'s dramatic leap attack slams down on her targeted Bloons.', 0, 0, 'abil:leaping_sword:desc:Leaping slam attack;30clt;20d;80md;20p;15r;type:normal;note:leaps to any bloon according to current targeting');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 6, '', 'Sauda preys on the Bloons\' weakness, doing extra damage if they are stunned, and she can now pop frozen Bloons.', 0, 0, 'type:shatter,+2d,note:(Lvl 7) +20 moab damage to stunned targets');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 7, '', 'Sauda attacks even faster.', 0, 0, '0.25s');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 8, '', 'Bloon Bleed: Sauda pops through 3 layers of Bloon with each strike, and causes a slow damage over time effect.', 0, 0, '+1d,+1cd,+1md,status:bleed:desc:Applied by basic attack damage;1d;20md;2s;4.05dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, true, 0, 9, 'Sword Charge', 'Sauda slides along the whole track, devastating Bloons as she goes.', 0, 0, 'abil:sword_charge:desc:Charge and damage along the whole path;45clt;20d;400p;type:normal;note:Can rehit;note:charges backwards along each path');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 10, '', 'Sauda inflicts extra damage to any Bloon slowed, immobilized, or taking damage over time from other monkeys.', 0, 0, '+2d,note:(Lvl 11) +10 moab damage to targets with any status other than stun or bleed');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 12, '', 'Enchanted blades do more damage and allow Sauda to damage all Bloons.', 0, 0, 'type:normal,note:(Lvl 13) +1 damage to stunned targets');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 16, '', 'Sauda\'s sword attacks slice through many Bloon layers at once.', 0, 0, '+1d,+1cd,+1md,note:(Lvl 17) +1 damage to targets with a status other than bleed,status:bleed:+9d;+30md;6dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 17, '', 'Sauda\'s swords attack with a blur of speed.', 0, 0, '0.1s');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 18, '', 'Enchanted Blades do extra damage to Regrow, Fortified, and Camo Bloons.', 0, 0, '+2d;note:(Lvl 19) +10 moab damage to targets with camo or regrow or fortified');
INSERT INTO `Abilities` VALUES (NULL, @tower_sauda, false, 0, 19, '', 'Sword Charge sweeps all track paths three times!', 0, 0, 'abil:leaping_sword:+500d;+20p,abil:sword_charge:+100d;+1000p;note:(Lvl 20) charges along each path 3 times in a row');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, true, 0, 2, 'Psychic Blast', 'Psi unleashes a wave of power that stuns nearby Bloons for a long time.', 0, 0, 'abil:psychic_blast:desc:Unleash a wave of power that stuns;40clt;50p;60r;1s;1dur;status:stun:desc:Stuns bllons and blimps=6s=note:(Lvl 3) bloons 6.0 seconds and blimps 1.5 seconds');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 3, '', 'Psi\'s attack can hit another Bloon if very close to the targeted Bloon', 0, 0, '+1p,attack:splash:desc:Attack gained by Lvl 4;1p;6r;note:Applies vibrating status');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 4, '', 'The psionic vibrations destroy Bloons faster than normal.', 0, 0, 'status:vibrating:0.15s');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 5, '', 'Psi\'s powerful mind can penetrate through Lead Bloons.', 0, 0, '+lead,attack:splash:+1p');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 6, '', 'Psychic Blast pulses twice. Psi can now destroy Ceramic Bloons.', 0, 0, '+ceramic,abil:psychic_blast:+50p;2s;2dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 7, '', 'Destructive Resonance causes Bloons destroyed by Psi\'s main attack to damage other Bloons nearby.', 0, 0, 'status:vibrating:attack:vibrating_explosion:1d=10p=20r=type:plasma=desc:Vibrating status creates an explosion');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 8, '', 'Split the Mind. Psi can now target two different Bloons at once.', 0, 0, '+1j,note:(Lvl 9) copy of main attack that uses elite targeting');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, true, 0, 9, 'Psionic Scream', 'Psi unleashes a silent scream that throws the Bloons into utter chaos.', 0, 0, 'abil:psionic_scream:desc:Unleashes a silent scream;60clt;2000p;-1r;note:50% chance to apply vibrating status. otherwise the target is sent back 50-300 units;-purple;-blimp');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 10, '', 'The psionic vibrations destroy Bloons even faster.', 0, 0, 'status:vibrating:0.1s');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 11, '', 'Psychic Blast pulses three times.', 0, 0, 'abil:psychic_blast:4dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 12, '', 'Not even Purple Bloons can resist the power of Psi\'s mind attacks.', 0, 0, '+purple,abil:psionic_scream:+purple');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 13, '', 'Psi\'s immense psychic power allows targeting and destruction of MOABs.', 0, 0, 'status:vibrating:+3d,+moab');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 14, '', 'Destructive Resonance is more destructive.', 0, 0, 'status:vibrating:attack:vibrating_explosion:+2d');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 15, '', 'The psionic vibrations destroy Bloons very fast. Psi can now target BFBs.', 0, 0, 'status:vibrating:0.075s,+bfb');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 17, '', 'Psi\'s attacks affect Bloons within a larger radius of the target Bloon.', 0, 0, 'attack:splash:+3p;+9r');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 18, '', 'Destructive Resonance is much much more destructive.', 0, 0, 'status:vibrating:attack:vibrating_explosion:+7d=+10r');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 19, '', 'Psionic Scream holds and damages all Bloons on screen. Psi can now target DDTs and ZOMGs.', 0, 0, '+zomg,+ddt,+blimp,abil:psionic_scream:+zomg;+ddt;note:(Lvl 20) chance of applying vibrating increased to 100%');
