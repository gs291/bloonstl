...
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, false, 0, 3, 'Juggernaut', 'Hurls a giant spiked ball that pops lead and excels at crushing Ceramic Bloons.', 1800, 7500, '+1d,+2cd,+28p,+4.8r,1.0s,type:normal', 'lead,reb,kb', 'atksp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 1, 2, 'MOAB Mauler', 'MOAB Maulers do much more damage to MOAB-Class Bloons.', 1100, 2700, '+5r,+15md', 'blimp,moab,bfb,zomg', DEFAULT);
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 0, 'Enhanced Freeze', 'Attacks faster and freezes for longer.', 225, 160, '*75%s,note:(0-1-0) frozen status duration increased to 1.75 seconds', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 1, 'Deep Freeze', 'Freezes through 2 layers of Bloon.', 350, 500, 'note:(0-2-0) frozen status soaks through 1 layer and duration increased to 2.2 seconds', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 2, 2, 'Cryo Cannon', 'Shoots freezing bombs at Bloons over longer range.', 2250, 2500, '+1d,+19r,-10p,1.2s,-blimp,status:frozen:desc:Status applied by basic attack;|1.5dur,note:(0-0-3) Cannot target blimps', DEFAULT, 'blimp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 2, 'Bloon Dissolver', 'Extreme solvents melt two layers every second.', 2500, 2500, 'status:glued:1d;0.65s;1cd', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 4, 'The Bloon Solver', 'Bloons a problem? Here\'s the solution.', 22000, 37500, '2j,*25%s,status:glued:3cd;5md,attack:splat:|5p;|12r;note:(0-0-5) applies glued status;desc:Deals damage on basic attack contact', 'supp', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 3, 'Maim MOAB', 'Immobilizes MOAB-Class Bloons for a short time.', 5000, 10500, '+10d,status:stun:|2dur;desc:Applied by basic attack;note:(4-0-0) 2 second duration for MOABs & BFBs 1 seconds. ZOMGs & DDTs 0.5 seconds', 'cc,blimp,dps', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 2, 'Bouncing Bullet', 'Shots bounce to new targets up to 3 times.', 3200, 2500, '4i,note:(0-3-0) Basic attack now jumps to targets within 40 units', 'jump', DEFAULT);
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 1, 0, 'Barbed Darts', 'Sub''s darts can pop 5 Bloons each.', 450, 130, '+3p,cross:310:attack:sonar:+20p,cross:410:attack:radioactive:+20p', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 1, 1, 'Heat-tipped Darts', 'Heat tipped darts allow popping of Frozen and Lead Bloons.', 300, 600, 'type:normal,cross:320:attack:sonar:+30p,cross:420:attack:radioactive:+1ld;+30p', 'lead,frzn', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 1, 1, 'Spy Plane', 'Allows Monkey Ace to hit Camo Bloons.', 350, 600, '+1cmd,+camo', 'camo', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 2, 'Neva-Miss Targeting', 'Darts automatically seek out and pop Bloons by themselves.', 2800, 3000, 'note:(0-0-3) Moderate homing. Increased projectile speed', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 3, 'Spectre', 'Rapidly fires darts and bombs, dominating most Bloon types easily.', 23400, 19000, '$1r,0.06s,note:(0-0-4) alternately fires a dart and bomb,attack:dart:|2d;|2cd;|15p;desc:Alternatively fired by basic attack,attack:bomb:|3d;|2cd;|30p;|20r;type:|explosion;desc:Alternatively fired by basic attack', 'atksp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 4, 'Apache Prime', 'The Apache Prime leaves most Bloons wishing they''d never been inflated.', 45000, 55000, '+5d,+20p,type:energy,attack:machinegun:+4d;+4p;type:plasma,attack:rocket:+15md', 'dps,blnc', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 1, 2, 'Downdraft', 'Blows Bloons away from the Heli, back toward the entrance.', 3000, 3300, 'attack:downdraft:|1p;|32r;|0.15s;-blimp;-lead;desc:Attack gained by 0-3-0;note:sends bloons 32-150 units back', 'kb', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 0, 2, 'Laser Cannon', 'Rapid fires much more powerful laser blasts that can pop frozen Bloons.', 4250, 2600, '+1d,+5p,type:energy,status:shocked:+1dur', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 1, 'Powerful Darts', 'Darts move faster and can pop 3 bloons each.', 1200, 650, '+2p,type:shatter,cross:302:+1p,cross:402:+23p,note:(0-0-2) There is a bug from this crosspath: it overrides any other changes to damage type to shatter type', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 0, 1, 'Arcane Blast', 'Bigger, more powerful magic blasts pop through 2 layers of Bloon.', 450, 600, '+1d', DEFAULT, DEFAULT);
...
--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 2, 0, 'Intense magic', '	More powerful magic shots move faster and can pop more Bloons.', 275, 140, '+5p,cross:011:attack:fireball:attack:explosion:+5p,cross:021:attack:wall_of_fire:+4p,cross:031:attack:flame:+2p', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, false, 1, 1, 'Epic Range', 'Why settle for super when you can have EPIC?', 1400, 1300, '+2p,+12r,cross:025:-1p', 'rang', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 4, 'Legend of the Night', 'We turn to him, when all hope is lost...', 200000, 100000, '+8d,+15p,+2cd,+5md,+4r,abil:black_hole:|120clt;|8dur;desc:The map saver;note:anything about to leak is deleted instead', 'chmp,abil', 'cd');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 4, 'Grand Saboteur', 'Ability duration is longer, and MOAB-Class Bloons spawn with less health during the sabotage.', 22000, 35000, 'abil:sabotage-grand_sabotage:+15dur;note:(0-5-0) 25% damage to new blimps entering the map;note:(0-5-0) Grants +5 range and +1 MOAB damage to all Shinobi on screen', 'blimp', 'time');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, true, 1, 4, 'Carpet of Spikes', 'Regularly sets a carpet of spikes over the whole track.', 40000, 35000, '+16r,+3d,0.33s,abil:spike_storm:+2d;note:(0-5-0) additionally triggered automatically every 15 seconds', 'micr', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, true, 1, 3, 'Call To Arms', 'Call To Arms Ability: Gives all nearby Monkeys +50% attack speed and pops for a short time.', 20000, 20000, 'abil:call_to_arms:desc:Gain increased attack speed and perice;|45clt;|15dur;buff:ability_buff:desc:Increased percentage pierce and range buff=|50%p=|66.67%s', 'abil', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_village, false, 2, 4, 'Monkeyopolis', 'Absorbs all nearby Banana Farms and their income, freeing up space for new Monkeys.', 5000, 28000, 'note:(0-0-5) Gains $200 * (amount spent on sacrifices / 2000) per round. minimum $300,note:(0-0-5) *actual cost of this upgrade is $5000 times the number of non-tier-5 farms in range regardless of difficulty. These farms are sacrificed to the village when upgraded', DEFAULT, DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, false, 1, 2, 'Cleansing Foam', 'Sprays foam that removes Regrow and Camo and pops Lead Bloons.', 850, 2000, 'attack:place_foam:desc:Foam placed at a point;|60r;|2s;|1ld;|10p;type:|normal;|8.5dur;+decamo;+degrow', 'decamo,degrow,lead', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_engineer_monkey, true, 1, 4, 'Ultraboost', 'Ultra-Overclocked Monkeys gain a small but permanent boost every time they are overclocked.', 105000, 35000, '+15p,abil:overclock-ultraboost:35clt;note:(0-5-0) additionally applies a permanent 4% reload buff which stacks additively up to 10 times (in the case of villages this is +2.5% to range)', DEFAULT, 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_gwendolin, false, 0, 15, '', 'Firestorm has increased duration. Purple Bloons are no longer immune to Gwendolin\'s attacks.', 0, 17820, 'type:normal,abil:firestorm:status:burn:+4d=+5md=10.05dur', 'purp', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_admiral_brickell, true, 0, 6, 'Blast Chain', 'Increased attack range and Camo Bloon detection.', 0, 7381, '+8r,+camo,abil:blast_chain:desc:All sea mines have half attack cooldown and doubled projectile speed;|60clt;|10dur', 'camo,rang', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 0, '', 'Available Items! Shooty Turret, Stack of Old Nails, Creepy Idol, Jar of Pickles. Geraldo also has a short range magical attack.', 0, 0, 'note:(Lvl 1) Geraldo owns a shop containing multiple items in stock at a limited supply accessed using the ability button. Can restock some items after a certain number of rounds. Geraldo begins with the following items in his store: Shooty Turret. Stack of Old Nails. Creepy Idol. Jar of Pickles.,attack:explosion:desc:Zap on contact damage;|1d;|4p;|10r;type:|energy,abil:shooty_turret:desc:Shop Item;|250cost;note:5 rounds to restock 1 maximum of 4;note:*income is the item cost;attack:shooty_turret:desc:A permanent hand-crafted dart shooting turret.=attack:dart:|2d@|10p@|50r@|1.5s@type:|sharp,abil:stack_of_old_nails:desc:Shop Item;|50cost;note:5 rounds to restock 2 maximum of 10;note:*income is the item cost;attack:old_nails:desc:Road Item=|1d=|10p=|6r=type:sharp=|$dur|+camo,abil:creepy_idol:desc:Shop Item;|100cost;note:4 rounds to restock 1 maximum of 2;note:*income is the item cost;attack:creepy_idol:desc:Tower=|32r=+kb=note:every 4th bloon to enter the idol\'s range is sent back 100-200 units=note:blimps increase the counter but cannot be sent back=note:4 round lifetime,abil:jar_of_pickles:desc:Shop Item;|100cost;note:4 rounds to restock 1 maixmum of 4;note:*income is the item cost;buff:pickled:+1d=-1.25s=note:5 round duration', '', '');
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 1, '', 'New Item! Rare Quincy Action Figure - increases in value the longer you possess it!', 0, 180, 'abil:rare_quincy_action_figure:desc:Shop Item;|750cost;note:1 round to restock 1 maximum of 1;note:*income is the item cost;attack:quincy_figure:desc:Tower=32r=note:Value increases per round since unlock=note:Can be sold for 96% of the base cost and 100% of the added value', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 2, '', 'New Item! See Invisibility Potion - grants short term camo detection to a Monkey Tower or Hero. Geraldo\'s attack range increases.', 0, 460, '+5r,abil:see_invisibility_potion:desc:Shop Item;|200cost;note:10 rounds to restock 1. maximum of 2;note:*income is the item cost;buff:vision:desc:Applied by potion=+camo=note:10 round duration', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 3, '', 'New Item! Tube of Amaz-o-Glue - can be placed on the track to slow Bloons down.', 0, 1000, 'abil:tube_of_amaz_o_glue:desc:Shop item;|100cost;note:3 rounds to restock 1. maximum of 3;note:*income is the item cost;attack:amaz_o_glue:desc:Placed road item=|100p=|14r=|$dur=+camo=note:Expires after 4 full rounds=status:glued:|30dur@*0.5slow', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 4, '', 'New Item! Sharpening Stone - boosts the pierce of a Monkey Tower or Hero when doing sharp-type damage.', 0, 1860, '1s,abil:sharpening_stone:desc:Shop Item;|200cost;note:5 rounds to restock 1. maximum of 3;note:*income is the item cost;buff:sharpened:desc:Applied to towers with sharp type attacks=+1p', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 5, '', 'New Item! Worn Hero\'s Cape - turns a tier 2 or lower Dart Monkey into a Super Monkey! These converted Super Monkeys can only be upgraded to Tier 3.', 0, 3280, 'abil:worn_heroes_cape:desc:Shop Item;|1500cost;note:5 round to restock 1. maximum of 2;note:*income is the item cost;note:transform a dart monkey (up to tier 2) into a super monkey (restricted to tier 3)', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 6, '', 'New Item! Blade Trap - when a visible Bloon touches the trap, a Blade Maelstrom goes off. Geraldo\'s main attack increases in damage and pierce.', 0, 5180, '+1d,attack:explosion:+1d;+5p,abil:blade_trap:desc:Shop Item;|650cost;note:5 rounds to restock 1. maximum of 3;note:*income is the item cost;attack:blade_trap:desc:Placed road item=|6r=|$dur=attack:blades:desc:Trap on contact attack@|1d@|2j@|200p@|0.033s@type:|sharp@|3dur@+vis', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 7, '', 'New Item! Bottle of \'Gerry\'s Fire\' - 2.8 million Bloonville units of pure hot sauce fire! Gives a Monkey, Hero, or minion a fiery attack for 10 rounds.', 0, 8320, 'abil:gerrys_fire_hot_sauce:desc:Shop Item;|500cost;note:2 rounds to restock 1. maximum of 3;note:*income is the item cost;attack:chilli_monster:desc:Tower orbiter=attack:flame:|1d@|1cd@|4p@|50r@|0.1s@type:|fire@+vis=status:burn:desc:Burn applied by flame@|1d@|1.5s@|3.1dur@type:|fire', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 8, '', 'New Item! Fertilizer - targeted Banana Farms that produce visible bananas increase production and get a cash bonus over several rounds. Geraldo\'s main attack blast radius increases.', 0, 9380, 'attack:explosion:+3r,abil:fertilizer:desc:Shop Item;|300cost;note:5 rounds to restock. maximum of 2;note:*income is the item cost;buff:fertilised:desc:Farm buff=+0.25income=note:5 round duration', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 9, '', 'New Item! Pet Rabbit - aww what a cute widdle bunny wabbit!', 0, 13620, 'abil:pet_rabit:desc:Shop Item;|1500cost;note:3 rounds to restock 1. maximum of 2;note:*income is the item cost;attack:rabbit:desc:Placed tower=note:once 4 have been placed they will merge into a wererabbit;attack:wererabbit:desc:Rabbit merged tower=attack:pounce:|10d@|30cd@|30md@|10p@|80r@|0.a4s@type:|normal@note:+1 damage for every 3000 RBE on scree. capped at +30', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 10, '', 'New Item! Rejuv Potion - resets all Monkey Tower and Hero cooldowns, restores 50 lives. Geraldo\'s main attack pierce increases, and Jar of Pickles grants bonus damages vs. Fortified Bloons.', 0, 16380, 'attack:explosion:+10p,abil:rejuv_potion:desc:Shop Item;|2000cost;note:5 rounds to restock 1. maximum of 2;note:heals 50 lives;note:Reset all ability cooldowns;note:*income is the item cost,abil:jar_of_pickles:buff:pickled:+1fd', DEFAULT, DEFAULT);
INSERT INTO `Abilities` VALUES (NULL, @tower_geraldo, false, 0, 11, '', 'New Item! Genie Bottle - summons a plasma-powered Genie Monkey that lasts for 3 rounds. Creepy Idol can now apply an occasional short stun to passive visible MOAB-class Bloons.', 0, 14400, 'abil:creepy_idol:attack:creepy_idol:note:(Lvl 12) every 4th blimp to enter the idol\'s range is stunned (MOAB 3s, BFB 2s, ZOMG or DDT 1s),abil:genie_bottle:desc:Shop Item;|2000cost;note:5 round to restock 1. maximum of 2;note:*income is the item cost;attack:genie:desc:Placed tower=|33r=attack:magic_bold:|20d@|5p@|100r@|0.2s@type:|plasma@+vis=note:Flies in a figure 8 around the center of the map=note:2 round lifetime', DEFAULT, DEFAULT);
