...
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 19, '', 'Psionic Scream holds and damages all Bloons on screen. Psi can now target DDTs and ZOMGs.', 0, 25920, '+zomg,+ddt,+blimp,abil:psionic_scream:+zomg;+ddt;note:(Lvl 20) chance of applying vibrating increased to 100%');
