...
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, true, 1, 4, 'Plasma Monkey Fan Club', 'Elite membership of this club grants the Dart Monkeys even more power!', 50000, 30000, 'abil:super_monkey_fan_club:50clt;15dur;attack:superfans:2d=5p=40r=0.03=type:plasma;note:(0-5-0) transforms 20 nearest dart monkeys (with upgrades up to 2-5-2) into plasmafans;note:upgrades such as 1-X-X are inherited');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 2, 'Razor Rotors', 'Razor Rotor blades rip up Bloons on contact, including Lead and Frozen Bloons.', 1750, 2700, 'attack:rotor:2d;10p;35r;0.75;type:normal;desc:Attack gained by 3-0-0');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 4, 'Special Poperations', 'Deploys a powerful special Monkey Marine with machine gun.', 30000, 40000, 'abil:special_poperations:25clt;30dur;6d;20p;50r;0.05s;type:normal,abil:supplies:+2700;note:(0-5-0) +15 lives');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 3, 'Dark Champion', 'Champion dark blades excel at puncturing and ruining all Bloon types.Gains long-range Darkshift Ability', 60000, 47500, '+1d,+1md,+2p,*50%s,type:normal,status:knockback:100% slow to leads and ceramics,abil:darkshift:note:(0-0-4) can teleport anywhere');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, false, 1, 0, 'Stronger Acid', 'Acid potions dissolve Bloons faster.', 250, 140, 'status:acid:1d;1.5s;4.55dur;des:Acid status applied by basic attack');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_quincy, true, 0, 9, 'Storm of Arrows', 'Covers a large area in a deadly rain of arrows.', 0, 0, 'abil:storm_of_arrows:desc:Shower the screen with arrows;70clt;3dur;6d;6md;-1p;100r;0.05;type:sharp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_benjamin, false, 0, 11, '', 'Skimming increased to $2 per Bloon.', 0, 0, 'attack:skimming:(Lvl 12) Now a $2 income');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ezili, false, 0, 8, '', 'Ezili\'s attack strips off Camo, Regrow and Fortified properties from non-MOAB Class Bloons.', 0, 0, '+degrow,+deforitfy,+decamo,attack:splash:+degrow;+deforitfy;+decamo,note:(Lvl 9) Degrow, defortify and decamo not applied to blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_pat_fusty, false, 0, 4, '', 'Pat sometimes does a slap attack that pushes Bloons back a considerable distance.', 0, 0, 'attack:slap:desc:Replaces every 5th basic attack;10p;status:knockback:1dur=note:move backwards at 3x normal speed. Also applies aoe on contact');
