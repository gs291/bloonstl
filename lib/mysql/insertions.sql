...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_tower, true, 1, 3, 'MOAB Assassin', 'Assassinate MOAB ability: Special missile flies out and does massive damage to MOAB-Class Bloons.', 2720, 10000);
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_tower, true, 1, 4, 'MOAB Eliminator', 'Assassinate ability does 6x damage with a shorter cooldown.', 21250, 35000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 3, 'Blade Maelstrom', 'Blade Maelstrom ability: Covers the area in a storm of blades.', 2295, 9000);
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 4, 'Super Maelstrom', 'Even more powerful Maelstrom ability and lasts longer.', 12750, 28000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 4, 'Pre-Emptive Strike', 'Automatically triggers MOAB Assassin effect whenever MOAB-Class Bloon spawns from the Bloon entrance.', 27200, 45000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, true, 1, 4, 'M.A.D', 'Moab Assured Destroyer. Each missile does extreme damage to MOAB class bloons.', 55250, 60000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 4, 'Grand Saboteur', 'Ability duration is longer, and MOAB-Class Bloons spawn with less health during the sabotage.', 18700, 35000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 3, 'Jungle''s Bounty', 'Generates 200 money plus another 100 per Banana Farm type tower near the Druid.', 4250, 11000);
INSERT INTO `Abilities` VALUES (NULL, @tower_druid, true, 1, 4, 'Spirit of the Forest', 'Grows thorned vines along the path, dealing constant damage, regenerating lives and providing money every round.', 29750, 40000);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_spike_factory, true, 1, 4, 'Carpet of Spikes', 'Regularly sets a carpet of spikes over the whole track.', 35700, 35000);
