...
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, true, 1, 3, 'Super Monkey Fan Club', 'Super Monkey Fan Club ability: Converts up to 10 nearby Dart Monkeys including himself into Super Monkeys for 15 seconds. Regular attack speed also increased.', 8000, 9500, '*75%%s,abil_stats:50clt,15dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_dart_monkey, true, 1, 4, 'Plasma Monkey Fan Club', 'Elite membership of this club grants the Dart Monkeys even more power!', 50000, 30000, 'abil_stats:50clt,15dur');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 0, 'Improved Rangs', 'Can pop up to 8 Bloons per throw.', 200, 100, '+4p,cross:104:+100p');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 1, 'Glaives', 'Throws sharper and faster glaives instead of boomerangs.', 280, 520, '+5p,cross:204:+120p,+50%kbd,cross:205:note:press explosion has lower pierce but higher range');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 3, 'M.O.A.R Glaives', 'Mulitple Object Advanced Ricochet greatly enhances the already extraordinary powers of the Glaive Ricochet Monkey.', 3000, 8500, '+50p,*50%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 0, 4, 'Glaive Lord', 'Glaive Lord surrounds itself in 3 special glaives that shred anything that comes near. Glaive Lord\'s glaived now rip through MOAB-class Bloons, slowly tearing them apart from the inside.', 35000, 37500, '+1d,+5cd,+5md,+2fd,+900p,-13r,0.1s,+camo');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, true, 1, 3, 'Turbo Charge', 'Makes this Monkey attack incredibly fast for 10 seconds.', 4000, 9000, 'abil_stats:45clt;10dur;+1d;*14.2857%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, true, 1, 4, 'Perma Charge', 'Perma Charge has a permanent super fast attack speed. Ability increases the lethality even more.', 35000, 32000, '+2d,+4md,0.034s,abil_stats:40clt;15dur;+8d');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 0, 'Long Range Rangs', 'Can throw boomerangs further than normal.', 100, 110, '+6.45r,cross:501:+4.5r');
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 1, 'Red Hot Rangs', 'Allows boomerangs to pop Frozen and Lead Bloons and do more damage to all.', 300, 490, '+1d,cross:502:+1d,type:normal,cross:052:+3d;+4md');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, false, 2, 3, 'MOAB Press', 'Heavy Kylie boomerang hits MOAB-Class Bloons multiple times per throw and sometimes knocks them back a short way along the path.', 2200, 9500, '+attack:press:1d,4md,200p,49.45r,type:normal,extra:rehit;knockb,-bad');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 0, 'Bigger Bombs', 'Shoots larger bombs, they have a larger blast area and more popping power.', 350, 200, '+6p,cross:104:note:subcluster +36 pierce and +3.5 range but all other explosions +6 pierce and +50% range');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 1, 'Heavy Bombs', 'Heavy duty bombs can smash through 2 layers of Bloon at once.', 650, 1000, '+1d,+10p,cross:204:All explosions +10 pierce and +1d but subcluster +60 pierce');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 3, 'Bloon Impact', 'Explosions become so violent Bloons are stunned for a short time when they are hit.', 3600, 10000, '+3r,stunb-1');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 0, 4, 'Bloon Crush', 'Bloon shattering explosions do massive damage and can stun MOAB-Class Bloons.', 55000, 37500, '+9d,type:normal,stun-2');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, true, 1, 3, 'MOAB Assassin', 'Assassinate MOAB ability: Special missile flies out and does massive damage to MOAB-Class Bloons. Regular attack range and MOAB-class damage also increased.', 3200, 10000, '+5r,+3cd,+12md,abil_stats:30clt;750d');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, true, 1, 4, 'MOAB Eliminator', 'Assassinate ability does 6x damage with a shorter cooldown.', 25000, 35000, '+68md,type:normal,abil_stats:10clt;4500d');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 0, 'Extra Range', 'Increases attack range', 200, 150, '+7r');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 1, 'Frag Bombs', 'Explosions throw out sharp fragments that can pop more Bloons including Black Bloons.', 300, 600, '+2r,type:normal,attack:frags:1d;8j;1p;type:sharp,cross:302:note:frag explosion +1 pierce,cross:402:note:frags +1 damage,cross:502:note:frags +10 damage and +1 pierce');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 2, 'Cluster Bombs', 'Throws out secondary bombs instead of sharp fragments every shot.', 800, 2500, 'attack:frags-clusters:1d;8j;10p;type:normal');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 3, 'Recursive Cluster', 'Every second shot the cluster bombs send out more cluster bombs for even more destruction.', 2800, 10000, 'note:every other bomb replaced by superbomb which produce a regular explosion and supercluster');
INSERT INTO `Abilities` VALUES (NULL, @tower_bomb_shooter, false, 2, 4, 'Bomb Blitz', 'Deals much more damage and gains the passive Bomb Storm Ability - when lives are lost, the Bomb Storm automatically triggers which destroys all but the biggest of Bloons.', 35000, 25000, '+4d,abil_stats:40clt;passive;2000d;-1p;-1r;type:normal;camo');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, false, 0, 4, 'Inferno Ring', 'Deadly inferno of flame roasts Bloons into oblivion.', 50000, 32500, '+1d,+6md,+11.5r,0.1s,attack:meteor:700d;1p;-1r;4.0s;type:fire;+camo');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 3, 'Blade Maelstrom', 'Blade Maelstrom ability: Covers the area in a storm of blades.', 2700, 9000, 'abil_stats:1d;2j;200p;0.0333s;type:normal');
INSERT INTO `Abilities` VALUES (NULL, @tower_tack_shooter, true, 1, 4, 'Super Maelstrom', 'Even more powerful Maelstrom ability and lasts longer.', 15000, 28000, '+1d,type:normal,abil_stats:2d;4j;500p;0.0333s;type:normal');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 0, 0, 'Permafrost', 'Bloons move slowly even after thawing out.', 100, 160, 'status:permafrost:50%slow');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 0, 2, 'Ice Shards', 'Razor sharp shards fly out when Frozen Bloons pop.', 1500, 2500, '+5r,note:frozen bloons emit shards when popped');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 0, 3, 'Embrittlement', 'Detects Camo Bloons and all Bloons hit become brittle, taking extra damage for a short time and losing Camo & Regrow properties permanently.', 2200, 8250, '+camo,status:brittle:+1d;1dur,note:permafrost (now applies brittle status) and shards buffed');
...
--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 0, 'Enhanced Freeze', 'Attacks faster and freezes for longer.', 225, 160, '*75%s,2.2dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 1, 'Deep Freeze', 'Freezes through 2 layers of Bloon.', 350, 500, 'note:frozen status soacks through 1 layer');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, false, 1, 2, 'Arctic Wind', 'Greatly increases pierce & gains a super cold aura that slows Bloons and freezes water nearby.', 2900, 2500, '+60p,attack:slow:40%slow');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, true, 1, 3, 'Snowstorm', 'Freezes all bloons on screen, and briefly freezes white, zebra, camo and MOAB class.', 3000, 8500, '+10r,abil_stats:30clt;1d;-1p;-1r;+camo;type:shatter');
INSERT INTO `Abilities` VALUES (NULL, @tower_ice_monkey, true, 1, 4, 'Absolute Zero', 'Ability is so cold it freezes all regular Bloons for longer, including White, Zebra, and Camo, slows MOAB-class longer, and greatly increases the attack speed of all Ice Monkeys for the duration.', 26000, 27500, '+200p,+10r,+moab,abil_stats:20clt;1d;-1p;-1r;+camo;type:normal;buff');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 1, 'Corrosive Glue', 'Glued Bloons pop one layer every few seconds.', 300, 550, '+moab,status:glued:1d;2.3s;type:normal,cross:203:note:glue level 2,cross:205:note:glued status buffed');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 0, 4, 'The Bloon Solver', 'Bloons a problem? Here\'s the solution.', 22000, 37500, 'attack:glue-glue_bomb:2j;*25%s,status:glue:3cd;4md');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 1, 0, 'Bigger Globs', 'Can coat 2 Bloons per shot.', 100, 120, '+1p');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 1, 1, 'Glue Splatter', 'Splatters glue across up to 6 Bloons per shot.', 1800, 900, 'attack:glue-glue_bomb:note:on contact it splats,cross:520:+4p,+13r,cross:025:note:splat does 10 pierce');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 1, 2, 'Glue Hose', 'Shoots glue 3x as fast!', 3250, 2500, '34%s');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 3, 'Glue Strike', 'Glue Strike Ability: Glues all Bloons on screen, causing them to take more damage from all sources while it lasts.', 3500, 8500, 'abil_stats:30clt;-1p;-1r;+camo;-moab;status:weakening_glue:11dur');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, true, 1, 4, 'Glue Storm', 'Glue storm ability pelts the whole screen over 15 seconds with glue. Glued Bloons take extra damage while glued.', 15000, 25000, 'abil_stats:30clt;15dur;-1p;-1r;2.0s;+camo;status:weakening_glue:22dur');

--          Bottom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 0, 'Stickier Glue', 'Makes glue effect last much longer.', 120, 130, 'status:glued:+13dur,cross:051:note:weakening_glue 48s duration');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 1, 'Stronger Glue', 'Slows down Bloons even more.', 400, 600, 'status:glued:75%slow,cross:051:note:weakening_glue 90% slow');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 2, 'MOAB Glue', 'Improved glue formula allows it to stick to MOAB-Class Bloons.', 3400, 2500, '+moab,note:blimps slowed');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 3, 'Relentless Glue', 'Popped Bloons that were glued, leave a blob of glue on the track.', 3000, 8000, 'note:bloons drop blue on track when fully popped that keep applying the glue status up to 2 times');
INSERT INTO `Abilities` VALUES (NULL, @tower_glue_gunner, false, 2, 4, 'Super Glue', 'Glue so strong it temporarily immobilizes all affected Bloons!', 35000, 30000, '+5p,note:glue massive buff on all bloons and blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 3, 'Maim MOAB', 'Immobilizes MOAB-Class Bloons for a short time.', 5000, 10500, '+10d,status:stun:note:3s duration for MOABs & BFBs 1.5s. ZOMGs & DDTs 0.75s');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 0, 4, 'Cripple MOAB', 'Crippled MOABs are immobilized for longer and take extra damage from all other attacks.', 40000, 37500, '+50d,status:stun:note:MOAB 7s. BFB 6s. ZOMG 3s. DDT 4s,status:crippled:+5d;note:same durations as stun');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 1, 'Shrapnel Shot', 'Damaged bloons spray out a cone of sharp shrapnel.', 450, 600, 'extra_dmg:shrapnel:1d;5j;2p;type:sharp,cross:220:extra_dmg:shrapnel:+1d,cross:320:extra_dmg:shrapnel:+2d,cross:420:extra_dmg:shrapnel:+2d;note:applies stun,cross:520:extra_dmg:+6d;note:applies crippled');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 1, 2, 'Bouncing Bullet', 'Shots bounce to new targets up to 3 times.', 3200, 2500, '4i,extra:jump,extra_dmg:shrapnel:+1p');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, true, 1, 3, 'Supply Drop', 'Supply Drop Ability: drops a crate full of cash. Regular attack also damages Lead Bloons and increases Shrapnel popping power.', 7200, 11000, 'type:normal,extra_dmg:shrapnel:+3p,abil_stats:90clt;3mpr;+1200mon');
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, true, 1, 4, 'Elite Sniper', 'Supply Drop gives much more cash. Grants Elite targeting prio to all snipers.', 13000, 35000, '*40%s,buff,abil_stats:90clt;3mpr;+1800mon,note:gains elite targeting that prioritises First if bloons are past 75% of the track. Then Ceramics if there are any. Otherwise Strong');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_sniper_monkey, false, 2, 4, 'Elite Defender', 'A lost life gives this Sniper 4x attack speed for a short time in retaliation. Also attacks faster the further the Bloons are along the track.', 14000, 30000, '*50%s,abil_stats:10clt;7dur;*25%s;passive');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 3, 'Bloontonium Reactor', 'Submerge to detect Camo, pop Bloons and reduce ability cooldowns of nearby water-based monkeys by 15%.', 2500, 11000, 'attack:sonar:0.3s,attack:radioactive:1d;50p;52r;0.3s;type:shatter');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 0, 4, 'Energizer', 'Reduces ability cooldowns everywhere by 20%. While in radius, heroes earn XP 50% faster and water Monkey ability cooldowns are halved.', 32000, 33000, 'attack:radioactive:+2d;+950p');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 1, 2, 'Ballistic Missile', 'Missile seeks target over any distance and does extra MOAB and Ceramic damage.', 1400, 3000, '+8r,attack:missile:50r;1.105s;note:explodes after 0.6s');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 3, 'First Strike Capability', 'A devastating missile strike on the largest Bloon on screen.', 13000, 20000, 'abil_stats:60clt;0.6del;10000d;-1r;type:normal;+camo;note:penetrates blimp layers and creates an explosion with 350 damage. 80 pierce. 65 blast range. Is of normal type');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, true, 1, 4, 'Pre-Emptive Strike', 'Automatically triggers MOAB Assassin effect whenever MOAB-Class Bloon spawns from the Bloon entrance.', 32000, 45000, 'attack:missile:0.5s,abil_stats:45clt,note:missile explosions +9 damage. When a blimp enters the map gain pre-emptive-strike ability that does 750 damage. Can see camo. Is of normal type');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_sub, false, 2, 4, 'Sub Commander', 'Grants +4 pierce and +1 damage to all Subs in its radius.', 25000, 25000, '*50%s,buff:command');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 0, 3, 'Aircraft Carrier', 'Launches waves of fighter planes that strafe the Bloons.', 7500, 12500, 'attack:forward_dart:1d;2j;9p;0.15s,attack:radial_dart:1d;8j;9p;1.0s;passive,attack:moab_missile:-1r;3s;-bloon;note:on contact explodes with 15 damage. 3 pierce. 30 blast range. Also the new attacks do not inherit alchemist buffs');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 0, 4, 'Carrier Flagship', 'Does extra damage. Can place other Monkeys on the upper decks of the ship and increases attack speed of all water based Monkeys and Monkey Aces.', 25000, 37000, 'type:normal,attack:forward_dart:+1d;1j;+3cd;+5p;-1r;type:normal,attack:radial_dart:+1d;+3cd;+5p;type:normal,attack:moab_missile:*50%s,buff:flagship:*85%s');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 1, 2, 'Cannon Ship', 'Add a powerful cannon that shoots out powerful bombs.', 900, 2700, 'attack:cannonball:1.2s;note:On contact has an explosion with 1 damage. 28 pierce. 40 blast range. Explosion as the type. On contact frags with 1 damage. 8 projectiles. 1 pierce. Sharp as the type. And cannot be buffed');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, true, 1, 3, 'Monkey Pirates', 'Adds 2 cannons to the ship and cannon attacks do more damage. MOAB Takedown Ability: harpoons a MOAB class Bloon and brings it down.', 4500, 13000, 'attack:cannonball:+2j;1.3s,note:explosion +1 damage,abil_stats:50clt;1j;note: targets the strongest "small" blimp (not ZOMG or BAD) immediately removing it and gaining the full amount of cash it would have given');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, true, 1, 4, 'Pirate Lord', 'Greatly increased attack speed for all attacks and can shoot 3 grappling hooks at once, plundering extra cash from each MOAB-class Bloon taken down.', 21000, 35000, '*50%s,attack:grape:+4d;+5cd;*50%s,abil_stats:30clt;+2j;note:Hooks all blimps other than BAD. ZOMGs use 2 hooks.');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 2, 2, 'Merchantman', 'Generates cash each round automatically.', 2300, 3100, '+200mon,note:generated at end of round');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_buccaneer, false, 2, 3, 'Favored Trades', 'Attacks faster and generates lots of money per round. Monkeys in radius have increased sell value and can stack up to 3 Favored Trades for 95% max sell value.', 5500, 10000, '+300mon,*50%s,buff:cashback,note:cashback buff increases sellback price by 10%');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 0, 0, 'Rapid Fire', 'Shoots faster than normal.', 650, 160, '*75%s,cross:110:attack:pineapple:*60%s,cross:130:attack:bombing_run:*60%s');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 0, 2, 'Fighter Plane', 'Flies fast and launches anti-MOAB missiles.', 1000, 2700, 'note:flies 20%faster,attack:moab_missile:2j;3s;-bloon;note:on contact does an explosion with 18 damage. 4 pierce. 30 blast range. Explosion as its type');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 0, 3, 'Operation: Dart Storm', 'Shoots 16 darts per volley, and twice as fast.', 3000, 8000, '+4j,*50%s,attack:moab_missile:*50%s;note:explosion gains +6 damage');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 0, 4, 'Sky Shredder', 'The Bloons will wish they had never come.', 40000, 35000, '+2d,+2cd,+16j,+3p,*50%s,type:normal,attack:moab_missile:note:explosion now at 150 damage. +1 pierce. Normal is its type');

--          Middle Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 1, 0, 'Exploding Pineapple', 'Drops pineapples to the ground that explode violently after a few seconds.', 200, 120, 'attack:pineapple:2s;1d;20p;25r;type:explosion,cross:310:attack:moab_missile:note:explosion gains +2 pierce. +4.5 range,cross:014:attack:bomb:+15p,+3r');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 1, 1, 'Spy Plane', 'Allows Monkey Ace to hit Camo Bloons.', 350, 600, '+camo');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 1, 2, 'Bomber Ace', 'Drops a line of bombs when crossing the Bloon track.', 900, 2500, 'attack:pineapple-bombing_run:4j;1.7s;+2d;+10r');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 3, 'Ground Zero', 'Bomb damage increased significantly. Ability drops a huge bomb that destroys most things on screen.', 14000, 15000, 'attack:bombing_run:+7d;+20p,abil_stats:45clt;0.8del;700d;1000p;type:normal');
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, true, 1, 4, 'Tsar Bomba', 'A very, very large bomb. Someone put a stop to this craziness!', 35000, 30000, 'attack:bombing_run:type:normal,abil_stats:35clt;3000d;5000p;type:normal;status:stun:8.2dur');

--          Botttom Path
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 0, 'Sharper Darts', 'Darts can pop 8 Bloons each.', 500, 160, '+3p,cross:011:attack:pineapple:+12p,cross:031:attack:bombing_run:+12p');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 0, 'Quad Darts', 'Shoots 4 darts per volley instead of 2.', 800, 200, '+1j,cross:104:abil_stats:+2j');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 1, 'Pursuit', 'A new targeting option enables Heli to seek and pursue the Bloons automatically.', 500, 650, 'note:gains pursuite targeting option');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 0, 3, 'Apache Dartship', 'Adds a large missile array and powerful machine guns.', 19600, 650, '*75%s,attack:machinegun:1d;5p;42r;0.05s;type:sharp,attack:rocket:4j;173r;1s;note:on contact has an explosion with 2 damage. 40 pierce. 25 blast range. Explosion as its type');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 1, 1, 'IFR', 'Allows Heli Pilot to detect and shoot Camo Bloons.', 600, 650, '+camo');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 3, 'Support Chinook', 'Drops lives and cash crates, or can pick up and redeploy most Monkey types.', 12000, 15000, 'abil_stats:60clt;note:move a tower or. except for: aces. helis. farms. villages. aircraft carriers (4xx or 5xx buccaneers). temples (4xx or 5xx supers). or drop $1800 cash and 10 lives up to 3 times every round');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, true, 1, 4, 'Special Poperations', 'Deploys a powerful special Monkey Marine with machine gun.', 30000, 40000, 'abil_stats:25clt;30dur;6d;20p;50r;0.05s;type:normal,note:supplies increased by +$2700 and +15 lives');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 1, 'Faster Firing', 'Faster attack speed for all Heli attacks.', 350, 550, '*80%s,cross:032:attack:downdraft:*80%s,cross:402:attack:machinegun:*80%s;attack:rocket:*80%s,cross:052:note:ability marine 80% faster attak speed');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 2, 'MOAB Shove', 'Can collide with and shove MOAB-Class Bloons, reversing or slowing their movement. Shove is amplified by Bigger Jets and IFR upgrades.', 3500, 2500, 'attack:shove:1p;note:slows MOABs to -33% normal speed. BFBs to 0%. DDTs and ZOMGs to 33%,attack:rocket:-1r;3s;note:has an explosion with 1 damage. 2 ceramic damage. 2 moab damage. 10 pierce. 18 blast range. Explosion as its type');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 3, 'Comanche Defense', 'Automatically calls in 3 more Comanches when they\'re most needed.', 8500, 12500, 'attack:rocket:note:explosion increased by +2 damage. +20 pierce,abil_stats:1d;3j;3p;43r;0.15s;type:sharp;note:alterante rocket attack with 1 damage. 2 ceramic damage. 100 pierce. 18 blast range. Explosion as its type');
INSERT INTO `Abilities` VALUES (NULL, @tower_heli_pilot, false, 2, 4, 'Comanche Commander', 'Upgraded weapons. Also automatically calls in 3 more Comanches. Permanently.', 35000, 50000, '+1d,abil_stats:+1d');
...
--          Top Path
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 0, 'Bigger Blast', 'Bigger shells deliver a bigger blast radius.', 500, 180, '+5p,+8r,cross:103:note:flares have +20 range,cross:104:attack:strip:+5p;+8r,cross:105:attack:wall_of_fire+5p;+6r');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 2, 'Shell Shock', 'Each blast creates a shockwave that stuns Bloons at impact point and pops Bloons further out.', 1100, 2500, '+1d');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 3, 'The Big One', 'Devastating explosions pop 5 layers of bloon.', 8000, 15000, '+10r,status:stun_explosion:0.5dur;45p;19r;-moab;-black;-zebra,status:shockwave:1d;45p;57r;note:effect only on outer radius');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, false, 0, 4, 'The Biggest One', 'Smashes through 20 layers of Bloon over a huge area.', 28000, 36000, '+15d,+20cd,20md,+115p,+16r,type:normal,status:stun_explosion:+115p;+8r,status:shockwave:+115p;+10cd;+24r;type:normal');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, true, 1, 3, 'Artillery Battery', 'Artillery battery has 3 barrels for triple the pain.', 5500, 12500, '*25%,abil_stats:60clt;8dur;*25%s;+15%r');
INSERT INTO `Abilities` VALUES (NULL, @tower_mortar_monkey, true, 1, 4, 'Pop and Awe', 'Rains explosions over the whole screen, popping and immobilizing all Bloons for a few seconds.', 30000, 32000, '+9cd,+3md,+3fd,+3ld,+8sd,abil_stats:60clt;8dur;20d;-1p;-1r;1.0s;type:normal;status:stun:1dur');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 1, 2, 'Hydra Rocket Pods', 'Shoots depleted bloontonium missiles that can damage all Bloons types and trigger multiple explosions.', 5250, 2700, '+5p,0.132s,attack:explosion:1d;6p;8r;type:normal;note:explodes on contact');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, true, 1, 3, 'Rocket Storm', 'Rocket Storm ability: Launches a powerful storm of rockets in a wide cone.', 4800, 14000, '+2p,attack:explosion:+2p,abil_stats:40clt;9.5dur;1i;10j;0.5s;note:can shoot past obstacles. Also an explosion happens on contact with 6 damage. 10 pierce. 8 range. Normal as its type');
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, true, 1, 4, 'M.A.D', 'Moab Assured Destroyer. Slower firing mega missiles deal extreme damage to MOAB-class Bloons.', 60000, 60000, '550md,+4p,*300%s,attack:explosion:+2d,abil_stats:note:explosion increased +4 ceramic damage. +18 moab damage. +10 pierce. +4 range');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_dartling_gunner, false, 2, 4, 'Bloon Exclusion Zone', 'Upgraded to 6 barrels and massively increased damage. Bloons are excluded from existence', 58000, 55000, '+6j,0.25s,+4d,+2p,note:gains 2 more buckshot attacks');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, false, 1, 1, 'Wall of Fire', 'Creates a super hot wall of fire across the track to roast the Bloons as they pass.', 900, 700, 'attack:wall_of_fire:5.5clt;1d;15p;15r;0.15s;type:fire;passive,note:lasts for 4.5 second');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, true, 1, 3, 'Summon Phoenix', 'Powerful phoenix wreaks Bloon havoc for 20 seconds.', 4000, 13000, 'abil_stats:45clt;20dur;attack:flame2:5d=10p=-1r=0.1s=type:fire=+camo;note:summons phoenix subtower that does not inherit buffs, but can receive buffs by flying through their range of influence');
INSERT INTO `Abilities` VALUES (NULL, @tower_wizard_monkey, true, 1, 4, 'Wizard Lord Phoenix', 'Wizard Lord becomes a master of the flame, turns into a super powerful Lava Phoenix for a short time.', 54000, 35000, 'attack:fireball:attack:explosion:+18d,attack:wall_of_fire:+2d,attack:flame:+5d;+46p,abil_stats:45clt;20dur;attack:flame3:20d=50p=-1r=0.1s=type:normal=+camo;attack:meteor:50d=8j=500p=-1r=1s=passive=type:normal=+camo');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 1, 3, 'Tech Terror', 'Destroys most Bloons completely and utterly within blast radius.', 19000, 35000, '+2p,0.048s,type:plasma,abil_stats:45clt;2500d;2000p;70r;type:normal;+camo;+moab');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 1, 4, 'The Anti-Bloon', 'Program Directive><Eradicate Bloons><INITIATE>', 90000, 85000, '+4d,+5p,+10r,type:normal,50dc,13~17co,abil_stats:45clt;5000d;10000p;120r;type:normal;+camo;+moab');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 2, 'Dark Knight', 'Dark blades increase knockback and pierce and deal extra damage to MOAB-class Bloons. Gains Darkshift ability to shift to a nearby location.', 5500, 6500, '2md,+4p,status:knockback:note:90% slow to leads and ceramics,abil_stats:20clt;note:teleport to a chosen point within range');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 3, 'Dark Champion', 'Champion dark blades excel at puncturing and ruining all Bloon types.Gains long-range Darkshift Ability', 60000, 47500, '+1d,+1md,+2p,*50%s,type:normal,status:knockback:100% slow to leads and ceramics,abil_stats:note:can teleport anywhere');
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 4, 'Legend of the Night', 'We turn to him, when all hope is lost...', 240000, 100000, '+3d,+15p,+4r,abil_stats:120clt;8dur;note:anything about to leak is deleted instead');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 3, 'Bloon Sabotage', 'Lasts 15 seconds. During the sabotage, all Bloons move at half speed.', 5000, 14000, 'abil_stats:60clt;15dur;note:all bloons and blimps move at half speed but not children of blimps');
INSERT INTO `Abilities` VALUES (NULL, @tower_ninja_monkey, true, 1, 4, 'Grand Saboteur', 'Ability duration is longer, and MOAB-Class Bloons spawn with less health during the sabotage.', 22000, 35000, 'abil_stats:+15dur;note:25% damage to new blimps');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, true, 1, 3, 'Transforming Tonic', 'Turns Alchemist into powerful attack Monster for 20 seconds.', 4500, 10000, 'abil_stats:60clt;20dur;2d;6p;72r;0.03s;type:plasma;note:transforms into a monster that can see past obstacles but will collide with them');
INSERT INTO `Abilities` VALUES (NULL, @tower_alchemist, true, 1, 4, 'Total Transformation', 'Transforms five Monkeys nearby into crazy attack monsters for 20 seconds.', 45000, 28000, 'abil_stats:40clt;20dur;2d;10p;72r;0.03s;type:plasma;note:additionally transforms 5 nearby towers (tier 3 or lower) into monsters');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_banana_farm, 40, 0, 0, 0, 15, 'H', 'money');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_quincy, 50, 3, 1, 0.95, 0, 'U', 'sharp');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_gwendolin, 38, 3, 1, 0.5, 0, 'U', 'fire');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_obyn_greenfoot, 43, 4, 2, 1.35, 0, 'U', 'plasma');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_sauda, 25, 4, 1, 0.4, 0, 'U', 'sharp');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_captain_churchill, 63, 15, 1, 0.7, 0, 'U', 'explosion');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_benjamin, 0, 0, 0, 0, 0, 'U', 'hacks');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_ezili, 40, 5, 1, 1.2, 0, 'U', 'plasma');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_pat_fusty, 24, 5, 3, 1.1, 0, 'U', 'normal');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_adora, 45, 5, 1, 1, 0, 'U', 'plasma');
...
--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_admiral_brickell, 50, 1, 3, 0.8, 0, 'U', 'sharp');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 0, '', 'Over any range or obstacle, Psi sets up deadly vibrations that completely destroy one Bloon at a time. Can target Camo.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 1, '', 'Attacks slightly faster.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, true, 0, 2, 'Psychic Blast', 'Psi unleashes a wave of power that stuns nearby Bloons for a long time.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 3, '', 'Psi\'s attack can hit another Bloon if very close to the targeted Bloon', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 4, '', 'The psionic vibrations destroy Bloons faster than normal.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 5, '', 'Psi\'s powerful mind can penetrate through Lead Bloons.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 6, '', 'Psychic Blast pulses twice. Psi can now destroy Ceramic Bloons.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 7, '', 'Destructive Resonance causes Bloons destroyed by Psi\'s main attack to damage other Bloons nearby.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 8, '', 'Split the Mind. Psi can now target two different Bloons at once.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, true, 0, 9, 'Psionic Scream', 'Psi unleashes a silent scream that throws the Bloons into utter chaos.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 10, '', 'The psionic vibrations destroy Bloons even faster.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 11, '', 'Psychic Blast pulses three times.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 12, '', 'Not even Purple Bloons can resist the power of Psi\'s mind attacks.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 13, '', 'Psi\'s immense psychic power allows targeting and destruction of MOABs.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 14, '', 'Destructive Resonance is more destructive.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 15, '', 'The psionic vibrations destroy Bloons very fast. Psi can now target BFBs.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 16, '', 'Split the Mind. Psi can now target three different Bloons at once.', 0, 0, '');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 18, '', 'Destructive Resonance is much much more destructive.', 0, 0, '');
INSERT INTO `Abilities` VALUES (NULL, @tower_psi, false, 0, 19, '', 'Psionic Scream holds and damages all Bloons on screen. Psi can now target DDTs and ZOMGs.', 0, 0, '');

INSERT INTO `TowerTiersInfo` VALUES (NULL, @tower_psi, 'camo,stnb,eg,mg,lg,lead,cm,moab,supp', 'purp,lead,cm,xp');

--          Statistics
INSERT INTO `TowerStats` VALUES (NULL, @tower_psi, 20, 0, 1, 0.2, 0, 'U', 'psychic');
