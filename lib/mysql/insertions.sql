...
INSERT INTO `Abilities` VALUES (NULL, @tower_boomerang_monkey, true, 1, 3, 'Turbo Charge', 'Makes this Monkey attack incredibly fast for 10 seconds.', 4000, 9000, 'abil:turbo_charge:|45clt;|10dur;+1d;0.034s;desc:Buffs tower damage and increases attack speed to', 'abil', DEFAULT);
...
INSERT INTO `Abilities` VALUES (NULL, @tower_monkey_ace, false, 2, 4, 'Flying Fortress', 'This is a BIG plane', 100000, 45000, '*68.66%s,+2j,attack:dart:+2d;type:normal,attack:bomb:+2d,type:normal,note:(0-0-5) gains 2 more copies of barrage which target last and close', 'blnc', 'chep');
...
INSERT INTO `Abilities` VALUES (NULL, @tower_super_monkey, true, 2, 4, 'Legend of the Night', 'We turn to him, when all hope is lost...', 240000, 100000, '+3d,+15p,+4r,abil:black_hole:|120clt;|8dur;desc:The map saver;note:anything about to leak is deleted instead', 'chmp,abil', 'cd');
